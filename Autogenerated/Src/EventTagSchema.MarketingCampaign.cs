namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class EventTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
	...
	/// Events section tag.
	/// </summary>
	public class EventTag : Terrasoft.Configuration.BaseTag
	{
	...
	/// <exclude/>
	public partial class EventTag_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : EventTag
	{
