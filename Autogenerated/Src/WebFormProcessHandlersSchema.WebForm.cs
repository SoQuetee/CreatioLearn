namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class WebFormProcessHandlers_WebFormEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : WebFormProcessHandlers
	{
