namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class DepartmentSchema : Terrasoft.Configuration.BaseLookupSchema
	{
	...
	/// Department.
	/// </summary>
	public class Department : Terrasoft.Configuration.BaseLookup
	{
	...
	/// <exclude/>
	public partial class Department_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : Department
	{
