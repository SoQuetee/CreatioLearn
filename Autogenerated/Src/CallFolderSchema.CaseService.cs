namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CallFolder_CaseServiceEventsProcess<TEntity> : Terrasoft.Configuration.CallFolder_BaseEventsProcess<TEntity> where TEntity : CallFolder
	{
