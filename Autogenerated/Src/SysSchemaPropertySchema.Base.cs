namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysSchemaProperty_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysSchemaProperty
	{
