namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class KnowledgeBaseInCase_CaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : KnowledgeBaseInCase
	{
