namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ServiceCategory_SLMEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ServiceCategory
	{
