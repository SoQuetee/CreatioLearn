namespace Terrasoft.Configuration
{
	...
	public class VwRecepientEmailSchema : Terrasoft.Core.Entities.EntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new VwRecepientEmail_BaseEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class VwRecepientEmail_BaseEventsProcess<TEntity> : Terrasoft.Core.Process.EmbeddedProcess where TEntity : VwRecepientEmail
	{
	...
	public partial class VwRecepientEmail_BaseEventsProcess<TEntity>
	{
