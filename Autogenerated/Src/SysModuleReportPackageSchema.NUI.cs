namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysModuleReportPackage_NUIEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : SysModuleReportPackage
	{
