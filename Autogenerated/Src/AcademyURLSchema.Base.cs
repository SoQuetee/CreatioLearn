namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class AcademyURLSchema : Terrasoft.Configuration.BaseLookupSchema
	{
	...
	/// Academy URL.
	/// </summary>
	public class AcademyURL : Terrasoft.Configuration.BaseLookup
	{
	...
	/// <exclude/>
	public partial class AcademyURL_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : AcademyURL
	{
