namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ProblemPriority_ProblemEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ProblemPriority
	{
