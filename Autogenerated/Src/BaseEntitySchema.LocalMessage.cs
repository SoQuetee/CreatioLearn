namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	[IsVirtual]
	public class BaseEntitySchema : Terrasoft.Configuration.BaseEntity_Base_TerrasoftSchema
	{
	...
	/// Base object.
	/// </summary>
	public class BaseEntity : Terrasoft.Configuration.BaseEntity_Base_Terrasoft
	{
	...
	/// <exclude/>
	public partial class BaseEntity_LocalMessageEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : BaseEntity
	{
