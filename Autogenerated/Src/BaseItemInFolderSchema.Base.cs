namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BaseItemInFolder_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : BaseItemInFolder
	{
