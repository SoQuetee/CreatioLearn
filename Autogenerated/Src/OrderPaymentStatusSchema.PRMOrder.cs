namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class OrderPaymentStatusSchema : Terrasoft.Configuration.OrderPaymentStatus_Order_TerrasoftSchema
	{
	...
	/// </summary>
	public class OrderPaymentStatus : Terrasoft.Configuration.OrderPaymentStatus_Order_Terrasoft
	{
	...
	/// <exclude/>
	public partial class OrderPaymentStatus_PRMOrderEventsProcess<TEntity> : Terrasoft.Configuration.OrderPaymentStatus_OrderEventsProcess<TEntity> where TEntity : OrderPaymentStatus
	{
