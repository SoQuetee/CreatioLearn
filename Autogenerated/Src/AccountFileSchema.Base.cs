namespace Terrasoft.Configuration
{
	...
	public class AccountFileSchema : Terrasoft.Configuration.FileSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new AccountFile_BaseEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class AccountFile_BaseEventsProcess<TEntity> : Terrasoft.Configuration.File_PRMPortalEventsProcess<TEntity> where TEntity : AccountFile
	{
	...
	public partial class AccountFile_BaseEventsProcess<TEntity>
	{
