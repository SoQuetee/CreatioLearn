namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class EventType_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : EventType
	{
