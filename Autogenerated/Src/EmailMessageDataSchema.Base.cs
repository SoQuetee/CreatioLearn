namespace Terrasoft.Configuration
{
	...
	public class EmailMessageDataSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new EmailMessageData_BaseEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class EmailMessageData_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : EmailMessageData
	{
	...
	public partial class EmailMessageData_BaseEventsProcess<TEntity>
	{
