namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SegmentStatus_MarketingCommonEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SegmentStatus
	{
