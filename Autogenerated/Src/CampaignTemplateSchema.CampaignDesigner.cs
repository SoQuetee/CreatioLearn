namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CampaignTemplate_CampaignDesignerEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : CampaignTemplate
	{
