namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Lead_WebLeadForm_TerrasoftSchema : Terrasoft.Configuration.Lead_LeadManagement_TerrasoftSchema
	{
	...
	/// Lead.
	/// </summary>
	public class Lead_WebLeadForm_Terrasoft : Terrasoft.Configuration.Lead_LeadManagement_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Lead_WebLeadFormEventsProcess<TEntity> : Terrasoft.Configuration.Lead_LeadManagementEventsProcess<TEntity> where TEntity : Lead_WebLeadForm_Terrasoft
	{
