namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CampaignInTag_CampaignsEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : CampaignInTag
	{
