namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class LeadDisqualifyReason_LeadEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : LeadDisqualifyReason
	{
