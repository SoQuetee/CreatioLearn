namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysSSPCustomerSchema_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysSSPCustomerSchema
	{
