namespace Terrasoft.Configuration
{
	...
	public class CasePriority_Case_Terrasoft : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("CasePriority_Case_TerrasoftDeleted", e);
	...
	/// <exclude/>
	public partial class CasePriority_CaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : CasePriority_Case_Terrasoft
	{
