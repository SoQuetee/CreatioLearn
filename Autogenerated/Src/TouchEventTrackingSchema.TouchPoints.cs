namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class TouchEventTracking_TouchPointsEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : TouchEventTracking
	{
