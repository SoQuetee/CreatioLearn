namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class DeduplicateMergeRules_DeduplicationEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : DeduplicateMergeRules
	{
