namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class Lead_CoreLeadEventsProcess<TEntity> : Terrasoft.Configuration.Lead_MLLeadScoringEventsProcess<TEntity> where TEntity : Lead_CoreLead_Terrasoft
	{
