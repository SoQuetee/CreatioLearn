namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ReasonForLeaving_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ReasonForLeaving
	{
