namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ContactInTag_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : ContactInTag
	{
