namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysPrcHistoryLogBuffer_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysPrcHistoryLogBuffer
	{
