namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BaseProductEntry_ProductCatalogueEventsProcess<TEntity> : Terrasoft.Configuration.BaseProductEntry_BaseEventsProcess<TEntity> where TEntity : BaseProductEntry
	{
