namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class GlobalDuplicateSearchStatus_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : GlobalDuplicateSearchStatus
	{
