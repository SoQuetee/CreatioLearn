namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ServicePactInFolder_SLMITILServiceEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : ServicePactInFolder
	{
