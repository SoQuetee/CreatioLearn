namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ReleaseInFolder_ReleaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : ReleaseInFolder
	{
