namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysProcessLog_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysProcessLog_Base_Terrasoft
	{
