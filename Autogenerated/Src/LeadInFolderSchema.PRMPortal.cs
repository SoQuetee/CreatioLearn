namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class LeadInFolderSchema : Terrasoft.Configuration.LeadInFolder_Lead_TerrasoftSchema
	{
	...
	/// Lead in folder.
	/// </summary>
	public class LeadInFolder : Terrasoft.Configuration.LeadInFolder_Lead_Terrasoft
	{
	...
	/// <exclude/>
	public partial class LeadInFolder_PRMPortalEventsProcess<TEntity> : Terrasoft.Configuration.LeadInFolder_LeadEventsProcess<TEntity> where TEntity : LeadInFolder
	{
