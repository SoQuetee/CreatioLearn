namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class UsrTourOfferFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public UsrTourOfferFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "UsrTourOfferFolder";
		...
		public IEnumerable<UsrTourOfferFolder> UsrTourOfferFolderCollectionByParent {
			get;
			set;
		}

		public IEnumerable<UsrTourOfferInFolder> UsrTourOfferInFolderCollectionByFolder {
			get;
			set;
		}
		...
		public UsrTourOfferFolder Parent {
			get {
				return _parent ??
					(_parent = new UsrTourOfferFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}
