namespace Terrasoft.Configuration.OData
{
	...
	public class FileType : Terrasoft.Core.Entities.Entity
	{
		...
		public IEnumerable<MkpInstalledAppNewsFile> MkpInstalledAppNewsFileCollectionByType {
			get;
			set;
		}
		...
		public IEnumerable<UsrTourOfferFile> UsrTourOfferFileCollectionByType {
			get;
			set;
		}
