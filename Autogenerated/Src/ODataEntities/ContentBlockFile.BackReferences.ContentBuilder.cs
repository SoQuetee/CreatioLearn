namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ContentBlockFile : Terrasoft.Core.Entities.Entity
	{
		...
		public ContentBlockFile(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ContentBlockFile";
		...
		public ContentBlock ContentBlock {
			get {
				return _contentBlock ??
					(_contentBlock = new ContentBlock(LookupColumnEntities.GetEntity("ContentBlock")));
			}
		}
