namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class OpportunityDepartment : Terrasoft.Core.Entities.Entity
	{
		...
		public OpportunityDepartment(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "OpportunityDepartment";
		...
		public Contact SalesDirector {
			get {
				return _salesDirector ??
					(_salesDirector = new Contact(LookupColumnEntities.GetEntity("SalesDirector")));
			}
		}
