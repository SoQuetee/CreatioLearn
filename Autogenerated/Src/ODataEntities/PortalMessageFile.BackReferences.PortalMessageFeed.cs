namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class PortalMessageFile : Terrasoft.Core.Entities.Entity
	{
		...
		public PortalMessageFile(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "PortalMessageFile";
		...
		public PortalMessage PortalMessage {
			get {
				return _portalMessage ??
					(_portalMessage = new PortalMessage(LookupColumnEntities.GetEntity("PortalMessage")));
			}
		}
