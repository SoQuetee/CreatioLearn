namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ContactDecisionRole : Terrasoft.Core.Entities.Entity
	{
		...
		public ContactDecisionRole(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ContactDecisionRole";
		...
		public IEnumerable<FormSubmit> FormSubmitCollectionByContactDecisionRole {
			get;
			set;
		}
