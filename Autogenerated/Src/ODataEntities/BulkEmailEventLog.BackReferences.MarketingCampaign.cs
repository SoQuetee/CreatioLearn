namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class BulkEmailEventLog : Terrasoft.Core.Entities.Entity
	{
		...
		public BulkEmailEventLog(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "BulkEmailEventLog";
		...
		public BulkEmailEventResult Result {
			get {
				return _result ??
					(_result = new BulkEmailEventResult(LookupColumnEntities.GetEntity("Result")));
			}
		}
