namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class Department : Terrasoft.Core.Entities.Entity
	{
		...
		public Department(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "Department";
		...
		public IEnumerable<ConfItemUser> ConfItemUserCollectionByDepartment {
			get;
			set;
		}
		...
		public IEnumerable<ServiceObject> ServiceObjectCollectionByDepartment {
			get;
			set;
		}

		public IEnumerable<VwServiceRecepients> VwServiceRecepientsCollectionByDepartment {
			get;
			set;
		}
