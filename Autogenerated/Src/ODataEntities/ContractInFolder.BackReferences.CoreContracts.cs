namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ContractInFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public ContractInFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ContractInFolder";
		...
		private ContractFolder _folder;
		/// <summary>
		/// Folder.
		/// </summary>
		public ContractFolder Folder {
			get {
				return _folder ??
					(_folder = new ContractFolder(LookupColumnEntities.GetEntity("Folder")));
			}
		}
