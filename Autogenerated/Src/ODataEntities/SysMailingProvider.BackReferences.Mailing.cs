namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysMailingProvider : Terrasoft.Core.Entities.Entity
	{
		...
		public SysMailingProvider(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysMailingProvider";
		...
		public IEnumerable<SysMailingHandler> SysMailingHandlerCollectionByProvider {
			get;
			set;
		}
