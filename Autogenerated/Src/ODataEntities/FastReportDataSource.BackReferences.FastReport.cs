namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class FastReportDataSource : Terrasoft.Core.Entities.Entity
	{
		...
		public FastReportDataSource(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "FastReportDataSource";
		...
		public FastReportTemplate Template {
			get {
				return _template ??
					(_template = new FastReportTemplate(LookupColumnEntities.GetEntity("Template")));
			}
		}
		...
		public FRDataSourceType Type {
			get {
				return _type ??
					(_type = new FRDataSourceType(LookupColumnEntities.GetEntity("Type")));
			}
		}
