namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysProcessFile : Terrasoft.Core.Entities.Entity
	{
		...
		public SysProcessFile(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysProcessFile";
		...
		public SysProcessData SysProcess {
			get {
				return _sysProcess ??
					(_sysProcess = new SysProcessData(LookupColumnEntities.GetEntity("SysProcess")));
			}
		}
