namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class Gender : Terrasoft.Core.Entities.Entity
	{
		...
		public Gender(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "Gender";
		...
		public IEnumerable<FormSubmit> FormSubmitCollectionByGender {
			get;
			set;
		}
