namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class LeadType : Terrasoft.Core.Entities.Entity
	{
		...
		public LeadType(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "LeadType";
		...
		public IEnumerable<SiteEvent> SiteEventCollectionByLeadType {
			get;
			set;
		}
		...
		public IEnumerable<VwSiteEvent> VwSiteEventCollectionByLeadType {
			get;
			set;
		}
