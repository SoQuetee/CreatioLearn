namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysPrcHistoryLog : Terrasoft.Core.Entities.Entity
	{
		...
		public SysPrcHistoryLog(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysPrcHistoryLog";
		...
		private SysPrcHistoryLog _parent;
		/// <summary>
		/// Parent.
		/// </summary>
		public SysPrcHistoryLog Parent {
			get {
				return _parent ??
					(_parent = new SysPrcHistoryLog(LookupColumnEntities.GetEntity("Parent")));
			}
		}
