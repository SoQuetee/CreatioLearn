namespace Terrasoft.Configuration.OData
{
	...
	public class Contact : Terrasoft.Core.Entities.Entity
	{
		...
		public IEnumerable<UsrTour> UsrTourCollectionByUsrTourEmployee {
			get;
			set;
		}

		public IEnumerable<UsrTourOffer> UsrTourOfferCollectionByUsrTourOfferEmployee {
			get;
			set;
		}

		public IEnumerable<UsrTourOfferFile> UsrTourOfferFileCollectionByLockedBy {
			get;
			set;
		}
		...
		/// <summary>
		/// Аккаунт Twitter для доступа к данным.
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Аккаунт Facebook для доступа к данным.
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Аккаунт LinkedIn для доступа к данным.
		/// </summary>
		/// <remarks>
