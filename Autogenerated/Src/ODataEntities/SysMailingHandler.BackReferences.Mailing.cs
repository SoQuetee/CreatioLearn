namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysMailingHandler : Terrasoft.Core.Entities.Entity
	{
		...
		public SysMailingHandler(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysMailingHandler";
		...
		public SysMailingProvider Provider {
			get {
				return _provider ??
					(_provider = new SysMailingProvider(LookupColumnEntities.GetEntity("Provider")));
			}
		}
