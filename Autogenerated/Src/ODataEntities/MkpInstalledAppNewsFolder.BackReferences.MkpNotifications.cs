namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class MkpInstalledAppNewsFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public MkpInstalledAppNewsFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "MkpInstalledAppNewsFolder";
		...
		public IEnumerable<MkpInstalledAppNewsFolder> MkpInstalledAppNewsFolderCollectionByParent {
			get;
			set;
		}

		public IEnumerable<MkpInstalledAppNewsInFolder> MkpInstalledAppNewsInFolderCollectionByFolder {
			get;
			set;
		}
		...
		public MkpInstalledAppNewsFolder Parent {
			get {
				return _parent ??
					(_parent = new MkpInstalledAppNewsFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}
