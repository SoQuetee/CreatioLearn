namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class VwSysProcessMILog : Terrasoft.Core.Entities.Entity
	{
		...
		public VwSysProcessMILog(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "VwSysProcessMILog";
		...
		private VwSysProcessMILog _parent;
		/// <summary>
		/// Parent.
		/// </summary>
		public VwSysProcessMILog Parent {
			get {
				return _parent ??
					(_parent = new VwSysProcessMILog(LookupColumnEntities.GetEntity("Parent")));
			}
		}
		...
		public SysPrcSchemaElement IteratorElement {
			get {
				return _iteratorElement ??
					(_iteratorElement = new SysPrcSchemaElement(LookupColumnEntities.GetEntity("IteratorElement")));
			}
		}
