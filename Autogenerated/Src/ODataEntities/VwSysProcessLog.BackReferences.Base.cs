namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class VwSysProcessLog : Terrasoft.Core.Entities.Entity
	{
		...
		public VwSysProcessLog(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "VwSysProcessLog";
		...
		private VwSysProcessLog _parent;
		/// <summary>
		/// Parent.
		/// </summary>
		public VwSysProcessLog Parent {
			get {
				return _parent ??
					(_parent = new VwSysProcessLog(LookupColumnEntities.GetEntity("Parent")));
			}
		}
