namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class RelationTypeSchema : Terrasoft.Configuration.RelationType_Base_TerrasoftSchema
	{
	...
	/// Relationship type.
	/// </summary>
	public class RelationType : Terrasoft.Configuration.RelationType_Base_Terrasoft
	{
	...
	/// <exclude/>
	public partial class RelationType_RelationshipDesignerEventsProcess<TEntity> : Terrasoft.Configuration.RelationType_BaseEventsProcess<TEntity> where TEntity : RelationType
	{
