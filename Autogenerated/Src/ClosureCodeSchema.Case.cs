namespace Terrasoft.Configuration
{
	...
	public class ClosureCodeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new ClosureCode_CaseEventsProcess(userConnection);
		}
	...
	public class ClosureCode : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new ClosureCode_CaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: ClosureCode_CaseEventsProcess

	/// <exclude/>
	public partial class ClosureCode_CaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ClosureCode
	{

		public ClosureCode_CaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "ClosureCode_CaseEventsProcess";
	...
	/// <exclude/>
	public class ClosureCode_CaseEventsProcess : ClosureCode_CaseEventsProcess<ClosureCode>
	{
	...
	public partial class ClosureCode_CaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class ClosureCodeEventsProcess : ClosureCode_CaseEventsProcess
	{
