namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class TouchDevice_TouchPointsEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : TouchDevice
	{
