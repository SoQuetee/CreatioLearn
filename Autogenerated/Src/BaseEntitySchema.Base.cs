namespace Terrasoft.Configuration
{
	...
	public class BaseEntity_Base_TerrasoftSchema : Terrasoft.Core.Entities.EntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new BaseEntity_BaseEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class BaseEntity_BaseEventsProcess<TEntity> : Terrasoft.Core.Process.EmbeddedProcess where TEntity : BaseEntity_Base_Terrasoft
	{
	...
	public partial class BaseEntity_BaseEventsProcess<TEntity>
	{
