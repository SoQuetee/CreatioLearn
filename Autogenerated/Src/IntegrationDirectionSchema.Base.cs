namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class IntegrationDirection_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : IntegrationDirection
	{
