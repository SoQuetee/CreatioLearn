namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Activity_CaseService_TerrasoftSchema : Terrasoft.Configuration.Activity_Case_TerrasoftSchema
	{
	...
	/// Activity.
	/// </summary>
	public class Activity_CaseService_Terrasoft : Terrasoft.Configuration.Activity_Case_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Activity_CaseServiceEventsProcess<TEntity> : Terrasoft.Configuration.Activity_CaseEventsProcess<TEntity> where TEntity : Activity_CaseService_Terrasoft
	{
