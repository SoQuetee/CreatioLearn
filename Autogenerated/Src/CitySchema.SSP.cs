namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class CitySchema : Terrasoft.Configuration.City_Base_TerrasoftSchema
	{
	...
	/// City.
	/// </summary>
	public class City : Terrasoft.Configuration.City_Base_Terrasoft
	{
	...
	/// <exclude/>
	public partial class City_SSPEventsProcess<TEntity> : Terrasoft.Configuration.City_BaseEventsProcess<TEntity> where TEntity : City
	{
