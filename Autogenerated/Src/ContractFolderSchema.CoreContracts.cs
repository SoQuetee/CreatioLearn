namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ContractFolder_CoreContractsEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : ContractFolder
	{
