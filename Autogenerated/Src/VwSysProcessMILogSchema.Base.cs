namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwSysProcessMILog_BaseEventsProcess<TEntity> : Terrasoft.Configuration.VwSysProcessLog_BaseEventsProcess<TEntity> where TEntity : VwSysProcessMILog
	{
