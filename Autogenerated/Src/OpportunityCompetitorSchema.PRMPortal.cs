namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class OpportunityCompetitorSchema : Terrasoft.Configuration.OpportunityCompetitor_Opportunity_TerrasoftSchema
	{
	...
	/// Competitor.
	/// </summary>
	public class OpportunityCompetitor : Terrasoft.Configuration.OpportunityCompetitor_Opportunity_Terrasoft
	{
	...
	/// <exclude/>
	public partial class OpportunityCompetitor_PRMPortalEventsProcess<TEntity> : Terrasoft.Configuration.OpportunityCompetitor_OpportunityEventsProcess<TEntity> where TEntity : OpportunityCompetitor
	{
