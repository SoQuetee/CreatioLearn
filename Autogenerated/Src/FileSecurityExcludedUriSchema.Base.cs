namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class FileSecurityExcludedUri_BaseEventsProcess<TEntity> : Terrasoft.Configuration.Lookup_BaseEventsProcess<TEntity> where TEntity : FileSecurityExcludedUri
	{
