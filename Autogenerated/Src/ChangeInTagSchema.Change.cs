namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ChangeInTag_ChangeEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : ChangeInTag
	{
