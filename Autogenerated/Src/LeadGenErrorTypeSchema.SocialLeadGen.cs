namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class LeadGenErrorType_SocialLeadGenEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : LeadGenErrorType
	{
