namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class DuplicatesRuleInTag_DeduplicationEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : DuplicatesRuleInTag
	{
