namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class MLModelInTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
	...
	/// </summary>
	public class MLModelInTag : Terrasoft.Configuration.BaseEntityInTag
	{
	...
	/// <exclude/>
	public partial class MLModelInTag_MLEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : MLModelInTag
	{
