namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class DCAttributeType_DynamicContentEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : DCAttributeType
	{
