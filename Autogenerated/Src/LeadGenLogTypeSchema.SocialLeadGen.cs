namespace Terrasoft.Configuration
{
	...
	public class LeadGenLogTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new LeadGenLogType_SocialLeadGenEventsProcess(userConnection);
		}
	...
	public class LeadGenLogType : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new LeadGenLogType_SocialLeadGenEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: LeadGenLogType_SocialLeadGenEventsProcess

	/// <exclude/>
	public partial class LeadGenLogType_SocialLeadGenEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : LeadGenLogType
	{

		public LeadGenLogType_SocialLeadGenEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "LeadGenLogType_SocialLeadGenEventsProcess";
	...
	/// <exclude/>
	public class LeadGenLogType_SocialLeadGenEventsProcess : LeadGenLogType_SocialLeadGenEventsProcess<LeadGenLogType>
	{
	...
	public partial class LeadGenLogType_SocialLeadGenEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class LeadGenLogTypeEventsProcess : LeadGenLogType_SocialLeadGenEventsProcess
	{
