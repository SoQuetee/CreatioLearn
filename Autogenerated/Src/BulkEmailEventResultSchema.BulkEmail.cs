namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BulkEmailEventResult_BulkEmailEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : BulkEmailEventResult
	{
