namespace Terrasoft.Configuration
{
	...
	public class DelayedNotificationSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new DelayedNotification_CaseServiceEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class DelayedNotification_CaseServiceEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : DelayedNotification
	{
	...
	public partial class DelayedNotification_CaseServiceEventsProcess<TEntity>
	{
