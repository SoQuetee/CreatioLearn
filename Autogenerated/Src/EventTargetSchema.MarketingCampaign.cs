namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class EventTarget_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : EventTarget
	{
