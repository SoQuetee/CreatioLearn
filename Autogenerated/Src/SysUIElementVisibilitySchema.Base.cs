namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysUIElementVisibility_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : SysUIElementVisibility
	{
