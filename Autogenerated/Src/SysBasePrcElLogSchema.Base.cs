namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysBasePrcElLog_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysBasePrcElLog
	{
