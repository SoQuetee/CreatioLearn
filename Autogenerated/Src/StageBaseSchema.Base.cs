namespace Terrasoft.Configuration
{
	...
	public class StageBaseSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new StageBase_BaseEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class StageBase_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : StageBase
	{
	...
	public partial class StageBase_BaseEventsProcess<TEntity>
	{
