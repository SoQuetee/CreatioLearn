namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class MessageListener_MessageEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : MessageListener
	{
