namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SocialChannelInTag_ESNEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : SocialChannelInTag
	{
