namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Activity_OmnichannelMessaging_TerrasoftSchema : Terrasoft.Configuration.Activity_Exchange_TerrasoftSchema
	{
	...
	/// Activity.
	/// </summary>
	public class Activity_OmnichannelMessaging_Terrasoft : Terrasoft.Configuration.Activity_Exchange_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Activity_OmnichannelMessagingEventsProcess<TEntity> : Terrasoft.Configuration.Activity_ExchangeEventsProcess<TEntity> where TEntity : Activity_OmnichannelMessaging_Terrasoft
	{
