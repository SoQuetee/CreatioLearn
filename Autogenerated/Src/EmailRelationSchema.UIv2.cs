namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class EmailRelation_UIv2EventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : EmailRelation
	{
