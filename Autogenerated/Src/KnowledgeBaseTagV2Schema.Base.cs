namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class KnowledgeBaseTagV2_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : KnowledgeBaseTagV2
	{
