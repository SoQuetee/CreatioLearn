namespace Terrasoft.Configuration
{
	...
	public class AccountOwnershipSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new AccountOwnership_BaseEventsProcess(userConnection);
		}
	...
	public class AccountOwnership : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new AccountOwnership_BaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: AccountOwnership_BaseEventsProcess

	/// <exclude/>
	public partial class AccountOwnership_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : AccountOwnership
	{

		public AccountOwnership_BaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "AccountOwnership_BaseEventsProcess";
	...
	/// <exclude/>
	public class AccountOwnership_BaseEventsProcess : AccountOwnership_BaseEventsProcess<AccountOwnership>
	{
	...
	public partial class AccountOwnership_BaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class AccountOwnershipEventsProcess : AccountOwnership_BaseEventsProcess
	{
