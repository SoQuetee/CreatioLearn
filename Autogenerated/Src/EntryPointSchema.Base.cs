namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class EntryPoint_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : EntryPoint
	{
