namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class GeneratedWebFormFolder_WebFormEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : GeneratedWebFormFolder
	{
