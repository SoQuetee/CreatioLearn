namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class GeneratedWebFormInFolder_WebFormEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : GeneratedWebFormInFolder
	{
