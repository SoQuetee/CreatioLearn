namespace Terrasoft.Configuration
{
	...
	public class BaseTag_Base_Terrasoft : Terrasoft.Configuration.BaseEntity
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("BaseTag_Base_TerrasoftDeleted", e);
	...
	/// <exclude/>
	public partial class BaseTag_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : BaseTag_Base_Terrasoft
	{
