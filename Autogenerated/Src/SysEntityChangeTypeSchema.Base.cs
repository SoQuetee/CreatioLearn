namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysEntityChangeType_BaseEventsProcess<TEntity> : Terrasoft.Configuration.SysCodeLookup_BaseEventsProcess<TEntity> where TEntity : SysEntityChangeType
	{
