namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class CompetitorProductSchema : Terrasoft.Configuration.CompetitorProduct_Base_TerrasoftSchema
	{
	...
	/// Competitor product.
	/// </summary>
	public class CompetitorProduct : Terrasoft.Configuration.CompetitorProduct_Base_Terrasoft
	{
	...
	/// <exclude/>
	public partial class CompetitorProduct_PRMPortalEventsProcess<TEntity> : Terrasoft.Configuration.CompetitorProduct_BaseEventsProcess<TEntity> where TEntity : CompetitorProduct
	{
