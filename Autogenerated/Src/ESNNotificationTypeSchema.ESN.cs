namespace Terrasoft.Configuration
{
	...
	public class ESNNotificationTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new ESNNotificationType_ESNEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class ESNNotificationType_ESNEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ESNNotificationType
	{
	...
	public partial class ESNNotificationType_ESNEventsProcess<TEntity>
	{
