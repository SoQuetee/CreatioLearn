namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class OrderTagSchema : Terrasoft.Configuration.OrderTag_Order_TerrasoftSchema
	{
	...
	/// Orders section tag.
	/// </summary>
	public class OrderTag : Terrasoft.Configuration.OrderTag_Order_Terrasoft
	{
	...
	/// <exclude/>
	public partial class OrderTag_PRMOrderEventsProcess<TEntity> : Terrasoft.Configuration.OrderTag_OrderEventsProcess<TEntity> where TEntity : OrderTag
	{
