namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class AdminUnitFeatureState_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : AdminUnitFeatureState
	{
