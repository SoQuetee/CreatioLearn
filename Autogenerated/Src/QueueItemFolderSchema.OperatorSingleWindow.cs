namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class QueueItemFolder_OperatorSingleWindowEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : QueueItemFolder
	{
