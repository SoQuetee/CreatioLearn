namespace Terrasoft.Configuration
{
	...
	public class Call_CaseService_Terrasoft : Terrasoft.Configuration.Call_Lead_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Call_CaseService_TerrasoftDeleted", e);
	...
	/// <exclude/>
	public partial class Call_CaseServiceEventsProcess<TEntity> : Terrasoft.Configuration.Call_LeadEventsProcess<TEntity> where TEntity : Call_CaseService_Terrasoft
	{
