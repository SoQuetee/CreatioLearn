namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwInvoiceProduct_InvoiceEventsProcess<TEntity> : Terrasoft.Configuration.InvoiceProduct_ProductCatalogueInInvoiceEventsProcess<TEntity> where TEntity : VwInvoiceProduct
	{
