namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ContractInFolder_CoreContractsEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : ContractInFolder
	{
