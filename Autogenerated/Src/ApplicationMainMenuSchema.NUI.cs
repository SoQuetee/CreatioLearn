namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ApplicationMainMenu_NUIEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ApplicationMainMenu
	{
