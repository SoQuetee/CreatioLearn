namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class JobSchema : Terrasoft.Configuration.Job_Base_TerrasoftSchema
	{
	...
	/// Job title.
	/// </summary>
	public class Job : Terrasoft.Configuration.Job_Base_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Job_SSPEventsProcess<TEntity> : Terrasoft.Configuration.Job_BaseEventsProcess<TEntity> where TEntity : Job
	{
