namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class SysProcessLogSchema : Terrasoft.Configuration.SysProcessLog_Base_TerrasoftSchema
	{
	...
	/// Process log (actual).
	/// </summary>
	public class SysProcessLog : Terrasoft.Configuration.SysProcessLog_Base_Terrasoft
	{
	...
	/// <exclude/>
	public partial class SysProcessLog_PRMPortalEventsProcess<TEntity> : Terrasoft.Configuration.SysProcessLog_BaseEventsProcess<TEntity> where TEntity : SysProcessLog
	{
