namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ProjectInTag_ProjectEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : ProjectInTag
	{
