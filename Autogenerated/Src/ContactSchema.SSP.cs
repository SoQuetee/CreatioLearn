namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Contact_SSP_TerrasoftSchema : Terrasoft.Configuration.Contact_Lead_TerrasoftSchema
	{
	...
	/// Contact.
	/// </summary>
	public class Contact_SSP_Terrasoft : Terrasoft.Configuration.Contact_Lead_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Contact_SSPEventsProcess<TEntity> : Terrasoft.Configuration.Contact_LeadEventsProcess<TEntity> where TEntity : Contact_SSP_Terrasoft
	{
