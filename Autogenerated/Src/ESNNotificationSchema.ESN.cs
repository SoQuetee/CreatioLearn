namespace Terrasoft.Configuration
{
	...
	public class ESNNotificationSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new ESNNotification_ESNEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class ESNNotification_ESNEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : ESNNotification
	{
