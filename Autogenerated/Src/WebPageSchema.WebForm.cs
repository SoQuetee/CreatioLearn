namespace Terrasoft.Configuration
{
	...
	public class WebPageSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new WebPage_WebFormEventsProcess(userConnection);
		}
	...
	public class WebPage : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new WebPage_WebFormEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: WebPage_WebFormEventsProcess

	/// <exclude/>
	public partial class WebPage_WebFormEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : WebPage
	{

		public WebPage_WebFormEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "WebPage_WebFormEventsProcess";
	...
	/// <exclude/>
	public class WebPage_WebFormEventsProcess : WebPage_WebFormEventsProcess<WebPage>
	{
	...
	public partial class WebPage_WebFormEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class WebPageEventsProcess : WebPage_WebFormEventsProcess
	{
