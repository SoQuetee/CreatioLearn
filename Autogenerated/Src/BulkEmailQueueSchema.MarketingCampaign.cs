namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BulkEmailQueue_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseTaskQueue_TasksQueueEventsProcess<TEntity> where TEntity : BulkEmailQueue
	{
