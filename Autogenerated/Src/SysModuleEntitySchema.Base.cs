namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysModuleEntity_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysModuleEntity_Base_Terrasoft
	{
