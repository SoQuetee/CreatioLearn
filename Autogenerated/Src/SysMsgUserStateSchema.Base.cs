namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysMsgUserState_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeImageLookup_BaseEventsProcess<TEntity> where TEntity : SysMsgUserState
	{
