namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysBaseSchemaOperationRight_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysBaseSchemaOperationRight
	{
