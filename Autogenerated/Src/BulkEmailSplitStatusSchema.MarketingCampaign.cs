namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BulkEmailSplitStatus_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : BulkEmailSplitStatus
	{
