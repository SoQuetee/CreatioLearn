namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysDashboard_PortalEventsProcess<TEntity> : Terrasoft.Configuration.SysDashboard_BaseEventsProcess<TEntity> where TEntity : SysDashboard
	{
