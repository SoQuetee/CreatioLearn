namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CampaignPlannerType_CampaignPlannerNewEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : CampaignPlannerType
	{
