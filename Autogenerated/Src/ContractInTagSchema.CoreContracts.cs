namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ContractInTag_CoreContractsEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : ContractInTag
	{
