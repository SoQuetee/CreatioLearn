namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SubjectResult_CTIBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : SubjectResult
	{
