namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ChangeCategory_ChangeEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ChangeCategory
	{
