namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ProjectInFolder_ProjectEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : ProjectInFolder
	{
