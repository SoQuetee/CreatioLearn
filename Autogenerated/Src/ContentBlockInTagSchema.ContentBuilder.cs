namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ContentBlockInTag_ContentBuilderEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : ContentBlockInTag
	{
