namespace Terrasoft.Configuration
{
	...
	#region Class: RelationType_Base_TerrasoftSchema

	/// <exclude/>
	public class RelationType_Base_TerrasoftSchema : Terrasoft.Configuration.BaseLookupSchema
	{

		#region Constructors: Public

		public RelationType_Base_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public RelationType_Base_TerrasoftSchema(RelationType_Base_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public RelationType_Base_TerrasoftSchema(RelationType_Base_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "RelationType_Base_Terrasoft";
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new RelationType_Base_Terrasoft(userConnection) {Schema = this};
		}
		...
		public override object Clone() {
			return new RelationType_Base_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new RelationType_Base_TerrasoftSchema(this, true);
		}
	...
	#region Class: RelationType_Base_Terrasoft

	/// <summary>
	/// Relationship type.
	/// </summary>
	public class RelationType_Base_Terrasoft : Terrasoft.Configuration.BaseLookup
	{

		#region Constructors: Public

		public RelationType_Base_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "RelationType_Base_Terrasoft";
		}

		public RelationType_Base_Terrasoft(RelationType_Base_Terrasoft source)
			: base(source) {
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("RelationType_Base_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("RelationType_Base_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("RelationType_Base_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("RelationType_Base_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("RelationType_Base_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("RelationType_Base_TerrasoftSaving", e);
			Validating += (s, e) => ThrowEvent("RelationType_Base_TerrasoftValidating", e);
		...
		public override object Clone() {
			return new RelationType_Base_Terrasoft(this);
		}
	...
	/// <exclude/>
	public partial class RelationType_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : RelationType_Base_Terrasoft
	{
	...
	/// <exclude/>
	public class RelationType_BaseEventsProcess : RelationType_BaseEventsProcess<RelationType_Base_Terrasoft>
	{
