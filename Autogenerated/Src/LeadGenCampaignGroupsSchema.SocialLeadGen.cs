namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class LeadGenCampaignGroups_SocialLeadGenEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : LeadGenCampaignGroups
	{
