namespace Terrasoft.Configuration
{
	...
	public class TerritorySchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new Territory_BaseEventsProcess(userConnection);
		}
	...
	public class Territory : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new Territory_BaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: Territory_BaseEventsProcess

	/// <exclude/>
	public partial class Territory_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : Territory
	{

		public Territory_BaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "Territory_BaseEventsProcess";
	...
	/// <exclude/>
	public class Territory_BaseEventsProcess : Territory_BaseEventsProcess<Territory>
	{
	...
	public partial class Territory_BaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class TerritoryEventsProcess : Territory_BaseEventsProcess
	{
