namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysModuleActionType_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : SysModuleActionType
	{
