namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysMailingHandler_MailingEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysMailingHandler
	{
