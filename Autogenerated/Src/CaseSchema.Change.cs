namespace Terrasoft.Configuration
{
	...
	public class CaseSchema : Terrasoft.Configuration.Case_Problem_TerrasoftSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new Case_ChangeEventsProcess(userConnection);
		}
	...
	public class Case : Terrasoft.Configuration.Case_Problem_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("CaseDeleted", e);
			Saved += (s, e) => ThrowEvent("CaseSaved", e);
			SaveError += (s, e) => ThrowEvent("CaseSaveError", e);
	...
	/// <exclude/>
	public partial class Case_ChangeEventsProcess<TEntity> : Terrasoft.Configuration.Case_ProblemEventsProcess<TEntity> where TEntity : Case
	{
	...
	public partial class Case_ChangeEventsProcess<TEntity>
	{
