namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class DCTemplate_DynamicContentEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : DCTemplate
	{
