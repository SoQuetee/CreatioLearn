namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CampaignLogStatus_CampaignsEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : CampaignLogStatus
	{
