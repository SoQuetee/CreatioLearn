namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CasePriority_CaseServiceEventsProcess<TEntity> : Terrasoft.Configuration.CasePriority_CaseEventsProcess<TEntity> where TEntity : CasePriority
	{
