namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class DocumentInTag_DocumentEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : DocumentInTag
	{
