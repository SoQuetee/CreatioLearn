namespace Terrasoft.Configuration
{
	...
	public class FileTypeSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new FileType_BaseEventsProcess(userConnection);
		}
	...
	public class FileType : Terrasoft.Configuration.BaseCodeLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new FileType_BaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: FileType_BaseEventsProcess

	/// <exclude/>
	public partial class FileType_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : FileType
	{

		public FileType_BaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "FileType_BaseEventsProcess";
	...
	/// <exclude/>
	public class FileType_BaseEventsProcess : FileType_BaseEventsProcess<FileType>
	{
	...
	public partial class FileType_BaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class FileTypeEventsProcess : FileType_BaseEventsProcess
	{
