namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class OrderFolder_Order_TerrasoftSchema : Terrasoft.Configuration.BaseFolderSchema
	{
	...
	/// Orders folder.
	/// </summary>
	public class OrderFolder_Order_Terrasoft : Terrasoft.Configuration.BaseFolder
	{
	...
	/// <exclude/>
	public partial class OrderFolder_OrderEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : OrderFolder_Order_Terrasoft
	{
