namespace Terrasoft.Configuration
{
	...
	public class BETArchiveFirstGenerationSchema : Terrasoft.Configuration.BulkEmailTargetSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new BETArchiveFirstGeneration_MarketingCampaignEventsProcess(userConnection);
		}
	...
	public class BETArchiveFirstGeneration : Terrasoft.Configuration.BulkEmailTarget
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new BETArchiveFirstGeneration_MarketingCampaignEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: BETArchiveFirstGeneration_MarketingCampaignEventsProcess

	/// <exclude/>
	public partial class BETArchiveFirstGeneration_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BulkEmailTarget_MarketingCampaignEventsProcess<TEntity> where TEntity : BETArchiveFirstGeneration
	{

		public BETArchiveFirstGeneration_MarketingCampaignEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "BETArchiveFirstGeneration_MarketingCampaignEventsProcess";
	...
	/// <exclude/>
	public class BETArchiveFirstGeneration_MarketingCampaignEventsProcess : BETArchiveFirstGeneration_MarketingCampaignEventsProcess<BETArchiveFirstGeneration>
	{
	...
	public partial class BETArchiveFirstGeneration_MarketingCampaignEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class BETArchiveFirstGenerationEventsProcess : BETArchiveFirstGeneration_MarketingCampaignEventsProcess
	{
