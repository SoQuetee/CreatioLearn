namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class EmployeeInTag_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : EmployeeInTag
	{
