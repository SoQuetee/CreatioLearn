namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class DocumentRelationship_DocumentEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : DocumentRelationship
	{
