namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class KnowledgeBaseTag_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : KnowledgeBaseTag
	{
