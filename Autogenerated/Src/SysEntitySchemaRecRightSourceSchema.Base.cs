namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysEntitySchemaRecRightSource_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : SysEntitySchemaRecRightSource
	{
