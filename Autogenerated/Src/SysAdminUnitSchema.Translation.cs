namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysAdminUnit_TranslationEventsProcess<TEntity> : Terrasoft.Configuration.SysAdminUnit_BaseEventsProcess<TEntity> where TEntity : SysAdminUnit_Translation_Terrasoft
	{
