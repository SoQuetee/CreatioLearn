namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BulkEmailSplitInFolder_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : BulkEmailSplitInFolder
	{
