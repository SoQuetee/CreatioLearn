namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class EventTeamRoles_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : EventTeamRoles
	{
