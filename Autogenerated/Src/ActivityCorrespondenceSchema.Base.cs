namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ActivityCorrespondence_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : ActivityCorrespondence
	{
