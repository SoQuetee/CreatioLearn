namespace Terrasoft.Configuration
{
	...
	public class DCAttributeInBlockSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new DCAttributeInBlock_DynamicContentEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class DCAttributeInBlock_DynamicContentEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : DCAttributeInBlock
	{
	...
	public partial class DCAttributeInBlock_DynamicContentEventsProcess<TEntity>
	{
