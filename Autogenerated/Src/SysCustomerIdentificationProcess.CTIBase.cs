	...
	public class SysCustomerIdentificationProcessSchema : Terrasoft.Core.Process.ProcessSchema
	{
		...
		protected virtual ProcessSchemaFormulaTask CreateFormulaTaskSetSearchIdFormulaTask() {
			ProcessSchemaFormulaTask FormulaTask = new ProcessSchemaFormulaTask(this) {
				...
				ZipBody = new byte[] { 31,139,8,0,0,0,0,0,4,0,139,86,14,174,44,14,75,44,202,76,76,202,73,213,115,44,45,201,119,47,205,76,81,142,5,0,88,38,247,74,24,0,0,0 }
			};
		...
		protected virtual ProcessSchemaFormulaTask CreateFormulaTask1FormulaTask() {
			ProcessSchemaFormulaTask FormulaTask = new ProcessSchemaFormulaTask(this) {
				...
				UseBackgroundMode = false,
				UseFlowEngineScriptVersion = false,
				ZipBody = new byte[] { 31,139,8,0,0,0,0,0,4,0,139,86,142,246,44,246,47,207,75,45,10,78,206,72,205,77,180,74,75,204,41,78,141,213,3,138,162,9,4,36,22,37,230,166,150,164,22,89,85,91,26,154,37,167,88,36,38,233,154,38,39,25,234,154,24,155,36,233,38,153,152,166,233,90,166,164,152,91,26,26,166,152,164,90,90,212,198,42,199,2,0,75,147,96,4,93,0,0,0 }
			};
