namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CampaignPlannerFolder_CampaignPlannerNewEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : CampaignPlannerFolder
	{
