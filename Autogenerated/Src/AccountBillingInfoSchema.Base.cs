namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class AccountBillingInfo_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : AccountBillingInfo
	{
