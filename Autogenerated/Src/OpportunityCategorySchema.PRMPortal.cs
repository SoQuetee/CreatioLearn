namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class OpportunityCategorySchema : Terrasoft.Configuration.OpportunityCategory_Opportunity_TerrasoftSchema
	{
	...
	/// </summary>
	public class OpportunityCategory : Terrasoft.Configuration.OpportunityCategory_Opportunity_Terrasoft
	{
	...
	/// <exclude/>
	public partial class OpportunityCategory_PRMPortalEventsProcess<TEntity> : Terrasoft.Configuration.OpportunityCategory_OpportunityEventsProcess<TEntity> where TEntity : OpportunityCategory
	{
