namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class OpportunitySchema : Terrasoft.Configuration.Opportunity_MLOpportunityScoring_TerrasoftSchema
	{
	...
	/// Opportunity.
	/// </summary>
	public class Opportunity : Terrasoft.Configuration.Opportunity_MLOpportunityScoring_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Opportunity_SalesEnterpriseEventsProcess<TEntity> : Terrasoft.Configuration.Opportunity_MLOpportunityScoringEventsProcess<TEntity> where TEntity : Opportunity
	{
