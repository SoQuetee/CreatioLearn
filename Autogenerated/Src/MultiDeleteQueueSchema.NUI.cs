namespace Terrasoft.Configuration
{
	...
	public class MultiDeleteQueueSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new MultiDeleteQueue_NUIEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class MultiDeleteQueue_NUIEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : MultiDeleteQueue
	{
	...
	public partial class MultiDeleteQueue_NUIEventsProcess<TEntity>
	{
