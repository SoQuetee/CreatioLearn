namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BaseAddress_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : BaseAddress
	{
