namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class RelationTypePosition_RelationshipDesignerEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : RelationTypePosition
	{
