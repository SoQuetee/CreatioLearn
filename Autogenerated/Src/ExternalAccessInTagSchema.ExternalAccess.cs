namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ExternalAccessInTag_ExternalAccessEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : ExternalAccessInTag
	{
