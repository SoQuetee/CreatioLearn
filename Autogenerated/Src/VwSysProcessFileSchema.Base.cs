namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwSysProcessFile_BaseEventsProcess<TEntity> : Terrasoft.Configuration.File_PRMPortalEventsProcess<TEntity> where TEntity : VwSysProcessFile
	{
