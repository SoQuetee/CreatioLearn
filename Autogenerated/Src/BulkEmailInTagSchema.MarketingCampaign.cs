namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BulkEmailInTag_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : BulkEmailInTag
	{
