namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ProjectEntryType_ProjectEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : ProjectEntryType
	{
