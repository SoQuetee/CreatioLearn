namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwDuplicatesRuleType_DeduplicationEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : VwDuplicatesRuleType
	{
