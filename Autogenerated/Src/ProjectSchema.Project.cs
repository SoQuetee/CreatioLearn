namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class Project_ProjectEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityNotes_BaseEventsProcess<TEntity> where TEntity : Project_Project_Terrasoft
	{
