namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class OpportunityFolderSchema : Terrasoft.Configuration.OpportunityFolder_Opportunity_TerrasoftSchema
	{
	...
	/// Opportunity folder.
	/// </summary>
	public class OpportunityFolder : Terrasoft.Configuration.OpportunityFolder_Opportunity_Terrasoft
	{
	...
	/// <exclude/>
	public partial class OpportunityFolder_PRMPortalEventsProcess<TEntity> : Terrasoft.Configuration.OpportunityFolder_OpportunityEventsProcess<TEntity> where TEntity : OpportunityFolder
	{
