namespace Terrasoft.Configuration
{
	...
	public class CampaignItemSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new CampaignItem_CampaignsEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class CampaignItem_CampaignsEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : CampaignItem
	{
	...
	public partial class CampaignItem_CampaignsEventsProcess<TEntity>
	{
