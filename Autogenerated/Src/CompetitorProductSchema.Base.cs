namespace Terrasoft.Configuration
{
	...
	public class CompetitorProduct_Base_Terrasoft : Terrasoft.Configuration.BaseEntity
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("CompetitorProduct_Base_TerrasoftDeleted", e);
	...
	/// <exclude/>
	public partial class CompetitorProduct_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : CompetitorProduct_Base_Terrasoft
	{
