namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysPrcElMILog_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysPrcElMILog
	{
