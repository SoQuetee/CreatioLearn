namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysPackageInInstalledApp_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysPackageInInstalledApp
	{
