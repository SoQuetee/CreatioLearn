namespace Terrasoft.Configuration
{
	...
	public class Specification_Specification_Terrasoft : Terrasoft.Configuration.BaseEntity
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Specification_Specification_TerrasoftDeleted", e);
	...
	/// <exclude/>
	public partial class Specification_SpecificationEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : Specification_Specification_Terrasoft
	{
