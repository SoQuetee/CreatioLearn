namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysFileContentStorage_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : SysFileContentStorage
	{
