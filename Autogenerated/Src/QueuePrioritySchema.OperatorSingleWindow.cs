namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class QueuePriority_OperatorSingleWindowEventsProcess<TEntity> : Terrasoft.Configuration.BaseValueLookup_BaseEventsProcess<TEntity> where TEntity : QueuePriority
	{
