namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class QueueStatus_OperatorSingleWindowEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : QueueStatus
	{
