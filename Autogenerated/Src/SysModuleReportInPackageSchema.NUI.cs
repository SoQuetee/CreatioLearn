namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysModuleReportInPackage_NUIEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysModuleReportInPackage
	{
