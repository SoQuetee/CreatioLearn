namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysPrcSchemaElement_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysPrcSchemaElement
	{
