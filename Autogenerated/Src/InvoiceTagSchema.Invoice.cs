namespace Terrasoft.Configuration
{
	...
	public class InvoiceTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new InvoiceTag_InvoiceEventsProcess(userConnection);
		}
	...
	public class InvoiceTag : Terrasoft.Configuration.BaseTag
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new InvoiceTag_InvoiceEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: InvoiceTag_InvoiceEventsProcess

	/// <exclude/>
	public partial class InvoiceTag_InvoiceEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : InvoiceTag
	{

		public InvoiceTag_InvoiceEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "InvoiceTag_InvoiceEventsProcess";
	...
	/// <exclude/>
	public class InvoiceTag_InvoiceEventsProcess : InvoiceTag_InvoiceEventsProcess<InvoiceTag>
	{
	...
	public partial class InvoiceTag_InvoiceEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class InvoiceTagEventsProcess : InvoiceTag_InvoiceEventsProcess
	{
