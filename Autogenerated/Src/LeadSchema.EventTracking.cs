namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class Lead_EventTrackingEventsProcess<TEntity> : Terrasoft.Configuration.Lead_OpportunityManagementEventsProcess<TEntity> where TEntity : Lead_EventTracking_Terrasoft
	{
