namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ContactsProductInterest_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseProductInterest_BaseEventsProcess<TEntity> where TEntity : ContactsProductInterest
	{
