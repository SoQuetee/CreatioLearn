namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BaseCodeLookup_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : BaseCodeLookup
	{
