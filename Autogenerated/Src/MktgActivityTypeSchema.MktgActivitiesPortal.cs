namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class MktgActivityType_MktgActivitiesPortalEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : MktgActivityType
	{
