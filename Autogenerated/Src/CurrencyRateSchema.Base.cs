namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CurrencyRate_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : CurrencyRate_Base_Terrasoft
	{
