namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class MLModelInFolder_MLEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : MLModelInFolder
	{
