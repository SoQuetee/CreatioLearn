namespace Terrasoft.Configuration
{
	...
	public class TagTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new TagType_BaseEventsProcess(userConnection);
		}
	...
	public class TagType : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new TagType_BaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: TagType_BaseEventsProcess

	/// <exclude/>
	public partial class TagType_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : TagType
	{

		public TagType_BaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "TagType_BaseEventsProcess";
	...
	/// <exclude/>
	public class TagType_BaseEventsProcess : TagType_BaseEventsProcess<TagType>
	{
	...
	public partial class TagType_BaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class TagTypeEventsProcess : TagType_BaseEventsProcess
	{
