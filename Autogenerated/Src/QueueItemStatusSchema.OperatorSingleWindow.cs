namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class QueueItemStatus_OperatorSingleWindowEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : QueueItemStatus
	{
