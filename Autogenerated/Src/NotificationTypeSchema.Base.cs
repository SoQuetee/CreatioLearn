namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class NotificationType_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : NotificationType
	{
