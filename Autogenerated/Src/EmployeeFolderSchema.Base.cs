namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class EmployeeFolder_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : EmployeeFolder
	{
