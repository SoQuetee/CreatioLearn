namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CaseRuleHandler_CaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : CaseRuleHandler
	{
