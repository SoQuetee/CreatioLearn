namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class EmailTemplateMacros_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.EmailTemplateMacros_BaseEventsProcess<TEntity> where TEntity : EmailTemplateMacros
	{
