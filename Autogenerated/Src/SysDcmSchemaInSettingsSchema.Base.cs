namespace Terrasoft.Configuration
{
	...
	#region Class: SysDcmSchemaInSettings_Base_TerrasoftSchema

	/// <exclude/>
	public class SysDcmSchemaInSettings_Base_TerrasoftSchema : Terrasoft.Configuration.BaseEntitySchema
	{

		#region Constructors: Public

		public SysDcmSchemaInSettings_Base_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public SysDcmSchemaInSettings_Base_TerrasoftSchema(SysDcmSchemaInSettings_Base_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public SysDcmSchemaInSettings_Base_TerrasoftSchema(SysDcmSchemaInSettings_Base_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "SysDcmSchemaInSettings_Base_Terrasoft";
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new SysDcmSchemaInSettings_Base_Terrasoft(userConnection) {Schema = this};
		}
		...
		public override object Clone() {
			return new SysDcmSchemaInSettings_Base_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new SysDcmSchemaInSettings_Base_TerrasoftSchema(this, true);
		}
	...
	#region Class: SysDcmSchemaInSettings_Base_Terrasoft

	/// <summary>
	/// SysDcmSchemaInSettings.
	/// </summary>
	public class SysDcmSchemaInSettings_Base_Terrasoft : Terrasoft.Configuration.BaseEntity
	{

		#region Constructors: Public

		public SysDcmSchemaInSettings_Base_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "SysDcmSchemaInSettings_Base_Terrasoft";
		}

		public SysDcmSchemaInSettings_Base_Terrasoft(SysDcmSchemaInSettings_Base_Terrasoft source)
			: base(source) {
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("SysDcmSchemaInSettings_Base_TerrasoftDeleted", e);
			Validating += (s, e) => ThrowEvent("SysDcmSchemaInSettings_Base_TerrasoftValidating", e);
		...
		public override object Clone() {
			return new SysDcmSchemaInSettings_Base_Terrasoft(this);
		}
	...
	/// <exclude/>
	public partial class SysDcmSchemaInSettings_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysDcmSchemaInSettings_Base_Terrasoft
	{
	...
	/// <exclude/>
	public class SysDcmSchemaInSettings_BaseEventsProcess : SysDcmSchemaInSettings_BaseEventsProcess<SysDcmSchemaInSettings_Base_Terrasoft>
	{
