namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysMailingProvider_MailingEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysMailingProvider
	{
