namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class DocumentStatus_DocumentEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : DocumentStatus
	{
