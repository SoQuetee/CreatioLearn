namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class MLModelState_MLBaseEventsProcess<TEntity> : Terrasoft.Configuration.SysCodeLookup_BaseEventsProcess<TEntity> where TEntity : MLModelState
	{
