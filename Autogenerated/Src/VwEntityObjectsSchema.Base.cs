namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwEntityObjects_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : VwEntityObjects
	{
