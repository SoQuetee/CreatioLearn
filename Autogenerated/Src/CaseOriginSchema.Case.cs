namespace Terrasoft.Configuration
{
	...
	public class CaseOriginSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new CaseOrigin_CaseEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class CaseOrigin_CaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : CaseOrigin
	{
	...
	public partial class CaseOrigin_CaseEventsProcess<TEntity>
	{
