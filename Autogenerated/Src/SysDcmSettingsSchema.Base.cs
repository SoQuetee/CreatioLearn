namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysDcmSettings_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysDcmSettings_Base_Terrasoft
	{
