namespace Terrasoft.Configuration
{
	...
	public class DCTemplateBlockSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new DCTemplateBlock_DynamicContentEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class DCTemplateBlock_DynamicContentEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : DCTemplateBlock
	{
	...
	public partial class DCTemplateBlock_DynamicContentEventsProcess<TEntity>
	{
