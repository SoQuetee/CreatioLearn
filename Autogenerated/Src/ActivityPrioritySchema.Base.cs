namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ActivityPriority_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ActivityPriority
	{
