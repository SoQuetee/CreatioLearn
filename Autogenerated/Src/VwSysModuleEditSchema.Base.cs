namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwSysModuleEdit_BaseEventsProcess<TEntity> : Terrasoft.Configuration.SysModuleEdit_BaseEventsProcess<TEntity> where TEntity : VwSysModuleEdit
	{
