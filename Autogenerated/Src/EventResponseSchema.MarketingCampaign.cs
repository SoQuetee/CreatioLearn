namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class EventResponse_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : EventResponse
	{
