namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class Portal_SysModule_SSPEventsProcess<TEntity> : Terrasoft.Configuration.SysModule_BaseEventsProcess<TEntity> where TEntity : Portal_SysModule
	{
