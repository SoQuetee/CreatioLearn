namespace Terrasoft.Configuration
{
	...
	public class EmailFolderColumnValuesSetting_Base_Terrasoft : Terrasoft.Configuration.BaseEntity
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("EmailFolderColumnValuesSetting_Base_TerrasoftDeleted", e);
	...
	/// <exclude/>
	public partial class EmailFolderColumnValuesSetting_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : EmailFolderColumnValuesSetting_Base_Terrasoft
	{
