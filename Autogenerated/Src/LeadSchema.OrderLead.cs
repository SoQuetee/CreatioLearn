namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Lead_OrderLead_TerrasoftSchema : Terrasoft.Configuration.Lead_MarketingCampaign_TerrasoftSchema
	{
	...
	/// Lead.
	/// </summary>
	public class Lead_OrderLead_Terrasoft : Terrasoft.Configuration.Lead_MarketingCampaign_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Lead_OrderLeadEventsProcess<TEntity> : Terrasoft.Configuration.Lead_MarketingCampaignEventsProcess<TEntity> where TEntity : Lead_OrderLead_Terrasoft
	{
