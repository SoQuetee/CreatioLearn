namespace Terrasoft.Configuration
{
	...
	public class SysProcessEntity_Base_Terrasoft : Terrasoft.Configuration.SysBaseProcessEntity
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("SysProcessEntity_Base_TerrasoftDeleted", e);
	...
	/// <exclude/>
	public partial class SysProcessEntity_BaseEventsProcess<TEntity> : Terrasoft.Configuration.SysBaseProcessEntity_BaseEventsProcess<TEntity> where TEntity : SysProcessEntity_Base_Terrasoft
	{
