namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class SpecificationSchema : Terrasoft.Configuration.Specification_Specification_TerrasoftSchema
	{
	...
	/// Specification.
	/// </summary>
	public class Specification : Terrasoft.Configuration.Specification_Specification_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Specification_PRMPortalEventsProcess<TEntity> : Terrasoft.Configuration.Specification_SpecificationEventsProcess<TEntity> where TEntity : Specification
	{
