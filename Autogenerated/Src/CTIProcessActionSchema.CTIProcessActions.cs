namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CTIProcessAction_CTIProcessActionsEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : CTIProcessAction
	{
