namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class EmailTemplateSendFlag_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : EmailTemplateSendFlag
	{
