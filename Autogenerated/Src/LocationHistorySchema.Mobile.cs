namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class LocationHistory_MobileEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : LocationHistory
	{
