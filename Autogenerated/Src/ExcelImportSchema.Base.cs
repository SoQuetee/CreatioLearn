namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ExcelImport_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : ExcelImport
	{
