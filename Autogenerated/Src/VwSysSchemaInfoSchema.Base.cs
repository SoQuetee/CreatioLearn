namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwSysSchemaInfo_BaseEventsProcess<TEntity> : Terrasoft.Configuration.VwSysSchemaInWorkspace_BaseEventsProcess<TEntity> where TEntity : VwSysSchemaInfo
	{
