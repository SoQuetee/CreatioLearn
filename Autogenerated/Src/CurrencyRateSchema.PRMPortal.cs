namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class CurrencyRate_PRMPortal_TerrasoftSchema : Terrasoft.Configuration.CurrencyRate_UIv2_TerrasoftSchema
	{
	...
	/// Exchange rate.
	/// </summary>
	public class CurrencyRate_PRMPortal_Terrasoft : Terrasoft.Configuration.CurrencyRate_UIv2_Terrasoft
	{
	...
	/// <exclude/>
	public partial class CurrencyRate_PRMPortalEventsProcess<TEntity> : Terrasoft.Configuration.CurrencyRate_UIv2EventsProcess<TEntity> where TEntity : CurrencyRate_PRMPortal_Terrasoft
	{
