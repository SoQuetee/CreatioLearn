namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class LoginPageCommunication_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : LoginPageCommunication
	{
