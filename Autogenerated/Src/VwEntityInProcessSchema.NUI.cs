namespace Terrasoft.Configuration
{
	...
	public class VwEntityInProcessSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new VwEntityInProcess_NUIEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class VwEntityInProcess_NUIEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : VwEntityInProcess
	{
	...
	public partial class VwEntityInProcess_NUIEventsProcess<TEntity>
	{
