namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class DeadlineCalcSchemas_CalendarEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : DeadlineCalcSchemas_Calendar_Terrasoft
	{
