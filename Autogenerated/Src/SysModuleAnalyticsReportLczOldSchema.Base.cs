namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysModuleAnalyticsReportLczOld_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLczEntity_BaseEventsProcess<TEntity> where TEntity : SysModuleAnalyticsReportLczOld
	{
