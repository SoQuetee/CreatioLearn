namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class InformationSource_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : InformationSource
	{
