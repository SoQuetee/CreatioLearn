namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class MailServerType_ExchangeEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : MailServerType
	{
