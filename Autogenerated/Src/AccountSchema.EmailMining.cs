namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Account_EmailMining_TerrasoftSchema : Terrasoft.Configuration.Account_Completeness_TerrasoftSchema
	{
	...
	/// Account.
	/// </summary>
	public class Account_EmailMining_Terrasoft : Terrasoft.Configuration.Account_Completeness_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Account_EmailMiningEventsProcess<TEntity> : Terrasoft.Configuration.Account_CompletenessEventsProcess<TEntity> where TEntity : Account_EmailMining_Terrasoft
	{
