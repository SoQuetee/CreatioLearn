namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class OpportunityTagSchema : Terrasoft.Configuration.OpportunityTag_Opportunity_TerrasoftSchema
	{
	...
	/// </summary>
	public class OpportunityTag : Terrasoft.Configuration.OpportunityTag_Opportunity_Terrasoft
	{
	...
	/// <exclude/>
	public partial class OpportunityTag_PRMPortalEventsProcess<TEntity> : Terrasoft.Configuration.OpportunityTag_OpportunityEventsProcess<TEntity> where TEntity : OpportunityTag
	{
