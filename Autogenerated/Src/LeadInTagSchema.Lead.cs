namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class LeadInTag_LeadEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : LeadInTag_Lead_Terrasoft
	{
