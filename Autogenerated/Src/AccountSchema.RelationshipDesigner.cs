namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Account_RelationshipDesigner_TerrasoftSchema : Terrasoft.Configuration.Account_EmailMining_TerrasoftSchema
	{
	...
	/// Account.
	/// </summary>
	public class Account_RelationshipDesigner_Terrasoft : Terrasoft.Configuration.Account_EmailMining_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Account_RelationshipDesignerEventsProcess<TEntity> : Terrasoft.Configuration.Account_EmailMiningEventsProcess<TEntity> where TEntity : Account_RelationshipDesigner_Terrasoft
	{
