namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysSettingsRights_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysSettingsRights
	{
