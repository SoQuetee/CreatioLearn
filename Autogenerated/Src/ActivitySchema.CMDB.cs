namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Activity_CMDB_TerrasoftSchema : Terrasoft.Configuration.Activity_Opportunity_TerrasoftSchema
	{
	...
	/// Activity.
	/// </summary>
	public class Activity_CMDB_Terrasoft : Terrasoft.Configuration.Activity_Opportunity_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Activity_CMDBEventsProcess<TEntity> : Terrasoft.Configuration.Activity_OpportunityEventsProcess<TEntity> where TEntity : Activity_CMDB_Terrasoft
	{
