namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SiteEventAttributeType_SiteEventEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : SiteEventAttributeType
	{
