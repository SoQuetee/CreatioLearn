namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class DuplicateStatus_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : DuplicateStatus
	{
