namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CaseNotificationRule_CaseServiceEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : CaseNotificationRule
	{
