namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class LeadSalesDirection_LeadEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : LeadSalesDirection
	{
