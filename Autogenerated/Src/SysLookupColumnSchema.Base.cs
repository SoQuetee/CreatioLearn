namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysLookupColumn_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysLookupColumn
	{
