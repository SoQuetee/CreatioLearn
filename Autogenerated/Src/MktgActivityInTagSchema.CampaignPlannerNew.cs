namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class MktgActivityInTag_CampaignPlannerNewEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : MktgActivityInTag
	{
