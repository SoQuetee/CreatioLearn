namespace Terrasoft.Configuration
{
	...
	public class SysModuleDetailSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new SysModuleDetail_BaseEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class SysModuleDetail_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysModuleDetail
	{
	...
	public partial class SysModuleDetail_BaseEventsProcess<TEntity>
	{
