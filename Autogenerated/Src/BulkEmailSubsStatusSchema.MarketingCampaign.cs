namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BulkEmailSubsStatus_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : BulkEmailSubsStatus
	{
