namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ConnectionType_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ConnectionType
	{
