namespace Terrasoft.Configuration
{
	...
	public class SenderObtainingService : BaseService
	{
		...
		public SenderObtainingServiceResponse ObtainSenderMailboxByActivityId(Guid activityId) {
			...
			try
			{
				var mailboxName = wrapper.GetSupportMailBox(activty.GetTypedColumnValue<string>(recepientColumnName), 
					activty.GetTypedColumnValue<Guid>(caseContactColumnName), activty.GetTypedColumnValue<Guid>(caseCategoryNameColumnName));
