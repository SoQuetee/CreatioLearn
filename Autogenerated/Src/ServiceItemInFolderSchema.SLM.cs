namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ServiceItemInFolder_SLMEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : ServiceItemInFolder
	{
