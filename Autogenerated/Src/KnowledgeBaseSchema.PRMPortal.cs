namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class KnowledgeBaseSchema : Terrasoft.Configuration.KnowledgeBase_Portal_TerrasoftSchema
	{
	...
	/// </summary>
	public class KnowledgeBase : Terrasoft.Configuration.KnowledgeBase_Portal_Terrasoft
	{
	...
	/// <exclude/>
	public partial class KnowledgeBase_PRMPortalEventsProcess<TEntity> : Terrasoft.Configuration.KnowledgeBase_PortalEventsProcess<TEntity> where TEntity : KnowledgeBase
	{
