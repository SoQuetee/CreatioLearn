namespace Terrasoft.Configuration
{
	...
	public class SysStoringObjectStateSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new SysStoringObjectState_BaseEventsProcess(userConnection);
		}
	...
	public class SysStoringObjectState : Terrasoft.Configuration.BaseCodeLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new SysStoringObjectState_BaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: SysStoringObjectState_BaseEventsProcess

	/// <exclude/>
	public partial class SysStoringObjectState_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : SysStoringObjectState
	{

		public SysStoringObjectState_BaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "SysStoringObjectState_BaseEventsProcess";
	...
	/// <exclude/>
	public class SysStoringObjectState_BaseEventsProcess : SysStoringObjectState_BaseEventsProcess<SysStoringObjectState>
	{
	...
	public partial class SysStoringObjectState_BaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class SysStoringObjectStateEventsProcess : SysStoringObjectState_BaseEventsProcess
	{
