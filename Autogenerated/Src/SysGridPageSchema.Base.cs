namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysGridPage_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysGridPage
	{
