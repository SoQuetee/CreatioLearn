namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BulkEmailLaunchOption_BulkEmailEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : BulkEmailLaunchOption
	{
