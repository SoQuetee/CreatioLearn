namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysPackageResourceChecksum_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysPackageResourceChecksum
	{
