namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class ContactCommunication_SSP_TerrasoftSchema : Terrasoft.Configuration.ContactCommunication_Base_TerrasoftSchema
	{
	...
	/// </summary>
	public class ContactCommunication_SSP_Terrasoft : Terrasoft.Configuration.ContactCommunication_Base_Terrasoft
	{
	...
	/// <exclude/>
	public partial class ContactCommunication_SSPEventsProcess<TEntity> : Terrasoft.Configuration.ContactCommunication_BaseEventsProcess<TEntity> where TEntity : ContactCommunication_SSP_Terrasoft
	{
