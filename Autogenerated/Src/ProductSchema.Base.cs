namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class Product_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : Product_Base_Terrasoft
	{
