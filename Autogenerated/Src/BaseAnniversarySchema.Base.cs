namespace Terrasoft.Configuration
{
	...
	public class BaseAnniversarySchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new BaseAnniversary_BaseEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class BaseAnniversary_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : BaseAnniversary
	{
	...
	public partial class BaseAnniversary_BaseEventsProcess<TEntity>
	{
