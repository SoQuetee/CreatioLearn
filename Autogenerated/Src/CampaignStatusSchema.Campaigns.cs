namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CampaignStatus_CampaignsEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : CampaignStatus
	{
