namespace Terrasoft.Configuration
{
	...
	public class BaseCodeImageLookupSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new BaseCodeImageLookup_BaseEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class BaseCodeImageLookup_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : BaseCodeImageLookup
	{
	...
	public partial class BaseCodeImageLookup_BaseEventsProcess<TEntity>
	{
