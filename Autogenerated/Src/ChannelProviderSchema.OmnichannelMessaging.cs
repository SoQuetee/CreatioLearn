namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ChannelProvider_OmnichannelMessagingEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ChannelProvider
	{
