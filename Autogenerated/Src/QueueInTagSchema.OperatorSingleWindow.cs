namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class QueueInTag_OperatorSingleWindowEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : QueueInTag
	{
