namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BulkEmailThrottlingMode_BulkEmailEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : BulkEmailThrottlingMode
	{
