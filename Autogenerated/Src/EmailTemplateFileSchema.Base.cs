namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class EmailTemplateFile_BaseEventsProcess<TEntity> : Terrasoft.Configuration.File_PRMPortalEventsProcess<TEntity> where TEntity : EmailTemplateFile
	{
