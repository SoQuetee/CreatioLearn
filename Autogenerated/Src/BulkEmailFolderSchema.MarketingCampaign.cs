namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class BulkEmailFolderSchema : Terrasoft.Configuration.BaseFolderSchema
	{
	...
	/// <summary>
	/// Section folder - "Email".
	/// </summary>
	public class BulkEmailFolder : Terrasoft.Configuration.BaseFolder
	{
	...
	/// <exclude/>
	public partial class BulkEmailFolder_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : BulkEmailFolder
	{
