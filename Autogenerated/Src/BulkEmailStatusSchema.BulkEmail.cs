namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BulkEmailStatus_BulkEmailEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : BulkEmailStatus
	{
