namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class IntegrationResult_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : IntegrationResult
	{
