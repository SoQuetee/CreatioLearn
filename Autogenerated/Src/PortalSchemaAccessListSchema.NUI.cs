namespace Terrasoft.Configuration
{
	...
	public class PortalSchemaAccessListSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new PortalSchemaAccessList_NUIEventsProcess(userConnection);
		}
	...
	public class PortalSchemaAccessList : Terrasoft.Configuration.BaseEntity
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new PortalSchemaAccessList_NUIEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: PortalSchemaAccessList_NUIEventsProcess

	/// <exclude/>
	public partial class PortalSchemaAccessList_NUIEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : PortalSchemaAccessList
	{

		public PortalSchemaAccessList_NUIEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "PortalSchemaAccessList_NUIEventsProcess";
	...
	/// <exclude/>
	public class PortalSchemaAccessList_NUIEventsProcess : PortalSchemaAccessList_NUIEventsProcess<PortalSchemaAccessList>
	{
	...
	public partial class PortalSchemaAccessList_NUIEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class PortalSchemaAccessListEventsProcess : PortalSchemaAccessList_NUIEventsProcess
	{
