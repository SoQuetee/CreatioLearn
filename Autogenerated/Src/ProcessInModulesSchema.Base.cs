namespace Terrasoft.Configuration
{
	...
	public class ProcessInModules_Base_Terrasoft : Terrasoft.Configuration.BaseEntity
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("ProcessInModules_Base_TerrasoftDeleted", e);
	...
	/// <exclude/>
	public partial class ProcessInModules_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : ProcessInModules_Base_Terrasoft
	{
