namespace Terrasoft.Configuration
{
	...
	public class File_Base_TerrasoftSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new File_BaseEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class File_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : File_Base_Terrasoft
	{
		...
		public override void ThrowEvent(ProcessExecutingContext context, string message) {
			switch(message) {
					...
					case "File_Base_TerrasoftUpdated":
						...
						break;
					case "File_Base_TerrasoftDeleting":
