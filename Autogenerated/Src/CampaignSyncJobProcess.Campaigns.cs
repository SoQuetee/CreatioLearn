	...
	public class CampaignSyncJobProcessSchema : Terrasoft.Core.Process.ProcessSchema
	{
		...
		protected virtual ProcessSchemaScriptTask CreateCampaignStepsUpdateScriptTaskScriptTask() {
			ProcessSchemaScriptTask ScriptTask = new ProcessSchemaScriptTask(this) {
				...
				ZipBody = new byte[] { 31,139,8,0,0,0,0,0,4,0,115,78,204,45,72,204,76,207,11,46,73,45,40,14,45,72,73,44,73,213,208,180,230,229,42,74,45,41,45,202,83,40,41,42,77,181,6,0,106,221,120,246,36,0,0,0 }
			};
