namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class JunkFilterTypeOfField_JunkFilterEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : JunkFilterTypeOfField
	{
