namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class EmailTemplateInTag_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : EmailTemplateInTag
	{
