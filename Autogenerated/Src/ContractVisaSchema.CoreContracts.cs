namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ContractVisa_CoreContractsEventsProcess<TEntity> : Terrasoft.Configuration.BaseVisa_NUIEventsProcess<TEntity> where TEntity : ContractVisa
	{
