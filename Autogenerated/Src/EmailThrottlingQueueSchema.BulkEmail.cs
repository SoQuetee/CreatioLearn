namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class EmailThrottlingQueue_BulkEmailEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : EmailThrottlingQueue
	{
