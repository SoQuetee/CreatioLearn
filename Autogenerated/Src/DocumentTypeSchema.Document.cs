namespace Terrasoft.Configuration
{
	...
	public class DocumentTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new DocumentType_DocumentEventsProcess(userConnection);
		}
	...
	public class DocumentType : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new DocumentType_DocumentEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: DocumentType_DocumentEventsProcess

	/// <exclude/>
	public partial class DocumentType_DocumentEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : DocumentType
	{

		public DocumentType_DocumentEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "DocumentType_DocumentEventsProcess";
	...
	/// <exclude/>
	public class DocumentType_DocumentEventsProcess : DocumentType_DocumentEventsProcess<DocumentType>
	{
	...
	public partial class DocumentType_DocumentEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class DocumentTypeEventsProcess : DocumentType_DocumentEventsProcess
	{
