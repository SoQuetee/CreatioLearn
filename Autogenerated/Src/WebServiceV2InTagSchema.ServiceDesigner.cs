namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class WebServiceV2InTag_ServiceDesignerEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : WebServiceV2InTag
	{
