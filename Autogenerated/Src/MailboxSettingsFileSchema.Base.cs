namespace Terrasoft.Configuration
{
	...
	public class MailboxSettingsFileSchema : Terrasoft.Configuration.FileSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new MailboxSettingsFile_BaseEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class MailboxSettingsFile_BaseEventsProcess<TEntity> : Terrasoft.Configuration.File_PRMPortalEventsProcess<TEntity> where TEntity : MailboxSettingsFile
	{
	...
	public partial class MailboxSettingsFile_BaseEventsProcess<TEntity>
	{
