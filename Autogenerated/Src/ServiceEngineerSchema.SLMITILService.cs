namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ServiceEngineer_SLMITILServiceEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : ServiceEngineer
	{
