namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class ProductFolderSchema : Terrasoft.Configuration.ProductFolder_Base_TerrasoftSchema
	{
	...
	/// Product folder.
	/// </summary>
	public class ProductFolder : Terrasoft.Configuration.ProductFolder_Base_Terrasoft
	{
	...
	/// <exclude/>
	public partial class ProductFolder_PRMOrderEventsProcess<TEntity> : Terrasoft.Configuration.ProductFolder_BaseEventsProcess<TEntity> where TEntity : ProductFolder
	{
