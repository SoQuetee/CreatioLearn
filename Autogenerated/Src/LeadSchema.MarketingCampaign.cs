namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Lead_MarketingCampaign_TerrasoftSchema : Terrasoft.Configuration.Lead_CoreLeadOpportunity_TerrasoftSchema
	{
	...
	/// Lead.
	/// </summary>
	public class Lead_MarketingCampaign_Terrasoft : Terrasoft.Configuration.Lead_CoreLeadOpportunity_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Lead_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.Lead_CoreLeadOpportunityEventsProcess<TEntity> where TEntity : Lead_MarketingCampaign_Terrasoft
	{
