namespace Terrasoft.Configuration
{
	...
	public class SocialMention_ESN_Terrasoft : Terrasoft.Configuration.BaseEntity
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("SocialMention_ESN_TerrasoftDeleted", e);
	...
	/// <exclude/>
	public partial class SocialMention_ESNEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SocialMention_ESN_Terrasoft
	{
