namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BulkEmailCategory_BulkEmailEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : BulkEmailCategory
	{
