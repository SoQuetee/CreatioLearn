namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CampaignFolder_CampaignsEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : CampaignFolder
	{
