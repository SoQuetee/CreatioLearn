namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class LinkContactToAccount_ExchangeEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : LinkContactToAccount
	{
