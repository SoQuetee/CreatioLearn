namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CampaignPlannerStatus_CampaignPlannerNewEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : CampaignPlannerStatus
	{
