namespace Terrasoft.Configuration
{
	...
	public class IntegrationOperationSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new IntegrationOperation_BaseEventsProcess(userConnection);
		}
	...
	public class IntegrationOperation : Terrasoft.Configuration.BaseCodeLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new IntegrationOperation_BaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: IntegrationOperation_BaseEventsProcess

	/// <exclude/>
	public partial class IntegrationOperation_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : IntegrationOperation
	{

		public IntegrationOperation_BaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "IntegrationOperation_BaseEventsProcess";
	...
	/// <exclude/>
	public class IntegrationOperation_BaseEventsProcess : IntegrationOperation_BaseEventsProcess<IntegrationOperation>
	{
	...
	public partial class IntegrationOperation_BaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class IntegrationOperationEventsProcess : IntegrationOperation_BaseEventsProcess
	{
