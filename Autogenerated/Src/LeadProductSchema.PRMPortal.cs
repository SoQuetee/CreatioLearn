namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class LeadProductSchema : Terrasoft.Configuration.LeadProduct_CoreLead_TerrasoftSchema
	{
	...
	/// Product in lead.
	/// </summary>
	public class LeadProduct : Terrasoft.Configuration.LeadProduct_CoreLead_Terrasoft
	{
	...
	/// <exclude/>
	public partial class LeadProduct_PRMPortalEventsProcess<TEntity> : Terrasoft.Configuration.LeadProduct_CoreLeadEventsProcess<TEntity> where TEntity : LeadProduct
	{
