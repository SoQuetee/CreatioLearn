namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class DisplayDateFormat_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : DisplayDateFormat
	{
