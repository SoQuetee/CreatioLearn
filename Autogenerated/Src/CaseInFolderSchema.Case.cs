namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CaseInFolder_CaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : CaseInFolder
	{
