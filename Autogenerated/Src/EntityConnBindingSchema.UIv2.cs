namespace Terrasoft.Configuration
{
	...
	public class EntityConnBindingSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new EntityConnBinding_UIv2EventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class EntityConnBinding_UIv2EventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : EntityConnBinding
	{
	...
	public partial class EntityConnBinding_UIv2EventsProcess<TEntity>
	{
