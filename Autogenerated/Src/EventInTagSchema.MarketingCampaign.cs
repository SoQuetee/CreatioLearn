namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class EventInTag_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : EventInTag
	{
