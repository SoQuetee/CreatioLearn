namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class TouchQueueOp_TouchPointsEventsProcess<TEntity> : Terrasoft.Configuration.TouchQueue_TouchPointsEventsProcess<TEntity> where TEntity : TouchQueueOp
	{
