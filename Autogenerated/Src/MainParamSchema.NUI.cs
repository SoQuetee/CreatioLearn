namespace Terrasoft.Configuration
{
	...
	public class MainParamSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new MainParam_NUIEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class MainParam_NUIEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : MainParam
	{
	...
	public partial class MainParam_NUIEventsProcess<TEntity>
	{
