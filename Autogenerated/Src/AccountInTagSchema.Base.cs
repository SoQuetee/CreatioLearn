namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class AccountInTag_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : AccountInTag
	{
