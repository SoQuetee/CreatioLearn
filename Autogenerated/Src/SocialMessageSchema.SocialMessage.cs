namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SocialMessage_SocialMessageEventsProcess<TEntity> : Terrasoft.Configuration.SocialMessage_ESNEventsProcess<TEntity> where TEntity : SocialMessage
	{
