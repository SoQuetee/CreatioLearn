namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ActivityInTag_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : ActivityInTag
	{
