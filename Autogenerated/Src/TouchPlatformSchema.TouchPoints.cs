namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class TouchPlatform_TouchPointsEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : TouchPlatform
	{
