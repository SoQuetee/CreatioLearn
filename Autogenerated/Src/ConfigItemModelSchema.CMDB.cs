namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ConfigItemModel_CMDBEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ConfigItemModel
	{
