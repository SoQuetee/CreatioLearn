namespace Terrasoft.Configuration
{
	...
	public class SysModuleGridSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new SysModuleGrid_BaseEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class SysModuleGrid_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysModuleGrid
	{
	...
	public partial class SysModuleGrid_BaseEventsProcess<TEntity>
	{
