namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SiteEventTypeInFolder_EventTrackingEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : SiteEventTypeInFolder
	{
