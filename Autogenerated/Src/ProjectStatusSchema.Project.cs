namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ProjectStatus_ProjectEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ProjectStatus
	{
