namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class DocumentInFolder_DocumentEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : DocumentInFolder
	{
