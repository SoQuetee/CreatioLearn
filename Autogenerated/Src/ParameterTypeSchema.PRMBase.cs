namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ParameterType_PRMBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ParameterType
	{
