namespace Terrasoft.Configuration
{
	...
	public class MLTrainSessionSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new MLTrainSession_MLBaseEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class MLTrainSession_MLBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : MLTrainSession
	{
	...
	public partial class MLTrainSession_MLBaseEventsProcess<TEntity>
	{
