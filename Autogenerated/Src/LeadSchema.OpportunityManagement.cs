namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Lead_OpportunityManagement_TerrasoftSchema : Terrasoft.Configuration.Lead_SocialLeadGen_TerrasoftSchema
	{
	...
	/// Lead.
	/// </summary>
	public class Lead_OpportunityManagement_Terrasoft : Terrasoft.Configuration.Lead_SocialLeadGen_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Lead_OpportunityManagementEventsProcess<TEntity> : Terrasoft.Configuration.Lead_SocialLeadGenEventsProcess<TEntity> where TEntity : Lead_OpportunityManagement_Terrasoft
	{
