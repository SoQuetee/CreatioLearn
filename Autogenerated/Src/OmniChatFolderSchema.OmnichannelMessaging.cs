namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class OmniChatFolder_OmnichannelMessagingEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : OmniChatFolder
	{
