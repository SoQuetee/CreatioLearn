namespace Terrasoft.Configuration
{
	...
	public class ProductFileSchema : Terrasoft.Configuration.FileSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new ProductFile_BaseEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class ProductFile_BaseEventsProcess<TEntity> : Terrasoft.Configuration.File_PRMPortalEventsProcess<TEntity> where TEntity : ProductFile
	{
	...
	public partial class ProductFile_BaseEventsProcess<TEntity>
	{
