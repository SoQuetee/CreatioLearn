namespace Terrasoft.Configuration
{
	...
	public class ReleaseFileSchema : Terrasoft.Configuration.FileSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new ReleaseFile_ReleaseEventsProcess(userConnection);
		}
	...
	public class ReleaseFile : Terrasoft.Configuration.File
	{
		...
		protected override void InitializeThrowEvents() {
			...
			Updated += (s, e) => ThrowEvent("ReleaseFileUpdated", e);
	...
	/// <exclude/>
	public partial class ReleaseFile_ReleaseEventsProcess<TEntity> : Terrasoft.Configuration.File_PRMPortalEventsProcess<TEntity> where TEntity : ReleaseFile
	{
	...
	public partial class ReleaseFile_ReleaseEventsProcess<TEntity>
	{
