namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Activity_OperatorSingleWindow_TerrasoftSchema : Terrasoft.Configuration.Activity_CaseService_TerrasoftSchema
	{
	...
	/// Activity.
	/// </summary>
	public class Activity_OperatorSingleWindow_Terrasoft : Terrasoft.Configuration.Activity_CaseService_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Activity_OperatorSingleWindow_TerrasoftDeleted", e);
	...
	/// <exclude/>
	public partial class Activity_OperatorSingleWindowEventsProcess<TEntity> : Terrasoft.Configuration.Activity_CaseServiceEventsProcess<TEntity> where TEntity : Activity_OperatorSingleWindow_Terrasoft
	{
