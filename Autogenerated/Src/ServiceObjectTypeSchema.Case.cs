namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ServiceObjectType_CaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ServiceObjectType
	{
