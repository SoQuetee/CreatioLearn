namespace Terrasoft.Configuration
{
	...
	public class VwRemindingsSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new VwRemindings_MobileEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class VwRemindings_MobileEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : VwRemindings
	{
	...
	public partial class VwRemindings_MobileEventsProcess<TEntity>
	{
