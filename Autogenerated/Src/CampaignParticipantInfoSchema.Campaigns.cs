namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CampaignParticipantInfo_CampaignsEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : CampaignParticipantInfo
	{
