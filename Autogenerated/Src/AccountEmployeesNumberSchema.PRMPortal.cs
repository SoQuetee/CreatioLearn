namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class AccountEmployeesNumberSchema : Terrasoft.Configuration.AccountEmployeesNumber_Base_TerrasoftSchema
	{
	...
	/// </summary>
	public class AccountEmployeesNumber : Terrasoft.Configuration.AccountEmployeesNumber_Base_Terrasoft
	{
	...
	/// <exclude/>
	public partial class AccountEmployeesNumber_PRMPortalEventsProcess<TEntity> : Terrasoft.Configuration.AccountEmployeesNumber_BaseEventsProcess<TEntity> where TEntity : AccountEmployeesNumber
	{
