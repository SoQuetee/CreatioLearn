namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class MessageNotifier_MessageEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : MessageNotifier
	{
