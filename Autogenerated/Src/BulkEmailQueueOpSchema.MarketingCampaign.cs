namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BulkEmailQueueOp_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BulkEmailQueue_MarketingCampaignEventsProcess<TEntity> where TEntity : BulkEmailQueueOp
	{
