namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class OpportunityParticipant_OpportunityEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : OpportunityParticipant
	{
