namespace Terrasoft.Configuration
{
	...
	public class OrderDeliveryStatus_Order_Terrasoft : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("OrderDeliveryStatus_Order_TerrasoftDeleted", e);
	...
	/// <exclude/>
	public partial class OrderDeliveryStatus_OrderEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : OrderDeliveryStatus_Order_Terrasoft
	{
