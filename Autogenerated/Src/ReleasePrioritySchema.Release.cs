namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ReleasePriority_ReleaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ReleasePriority
	{
