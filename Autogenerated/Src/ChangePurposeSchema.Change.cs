namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ChangePurpose_ChangeEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ChangePurpose
	{
