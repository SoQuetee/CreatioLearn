namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ContactFolder_CampaignsEventsProcess<TEntity> : Terrasoft.Configuration.ContactFolder_BaseEventsProcess<TEntity> where TEntity : ContactFolder
	{
