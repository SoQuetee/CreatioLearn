namespace Terrasoft.Configuration
{
	...
	public class WarehouseSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new Warehouse_ProductCatalogueEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class Warehouse_ProductCatalogueEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : Warehouse
	{
	...
	public partial class Warehouse_ProductCatalogueEventsProcess<TEntity>
	{
