namespace Terrasoft.Configuration
{
	...
	#region Class: OpportunityFile_Opportunity_TerrasoftSchema

	/// <exclude/>
	public class OpportunityFile_Opportunity_TerrasoftSchema : Terrasoft.Configuration.FileSchema
	{

		#region Constructors: Public

		public OpportunityFile_Opportunity_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public OpportunityFile_Opportunity_TerrasoftSchema(OpportunityFile_Opportunity_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public OpportunityFile_Opportunity_TerrasoftSchema(OpportunityFile_Opportunity_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "OpportunityFile_Opportunity_Terrasoft";
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new OpportunityFile_Opportunity_Terrasoft(userConnection) {Schema = this};
		}
		...
		public override object Clone() {
			return new OpportunityFile_Opportunity_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new OpportunityFile_Opportunity_TerrasoftSchema(this, true);
		}
	...
	#region Class: OpportunityFile_Opportunity_Terrasoft

	/// <summary>
	/// File and link of opportunity.
	/// </summary>
	public class OpportunityFile_Opportunity_Terrasoft : Terrasoft.Configuration.File
	{

		#region Constructors: Public

		public OpportunityFile_Opportunity_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "OpportunityFile_Opportunity_Terrasoft";
		}

		public OpportunityFile_Opportunity_Terrasoft(OpportunityFile_Opportunity_Terrasoft source)
			: base(source) {
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("OpportunityFile_Opportunity_TerrasoftDeleted", e);
			Updated += (s, e) => ThrowEvent("OpportunityFile_Opportunity_TerrasoftUpdated", e);
		...
		public override object Clone() {
			return new OpportunityFile_Opportunity_Terrasoft(this);
		}
	...
	/// <exclude/>
	public partial class OpportunityFile_OpportunityEventsProcess<TEntity> : Terrasoft.Configuration.File_PRMPortalEventsProcess<TEntity> where TEntity : OpportunityFile_Opportunity_Terrasoft
	{
	...
	/// <exclude/>
	public class OpportunityFile_OpportunityEventsProcess : OpportunityFile_OpportunityEventsProcess<OpportunityFile_Opportunity_Terrasoft>
	{
