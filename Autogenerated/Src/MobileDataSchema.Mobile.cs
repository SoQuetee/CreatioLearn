namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class MobileData_MobileEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : MobileData
	{
