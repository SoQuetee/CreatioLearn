namespace Terrasoft.Configuration
{
	...
	#region Class: EmailTemplateMacros_Base_TerrasoftSchema

	/// <exclude/>
	public class EmailTemplateMacros_Base_TerrasoftSchema : Terrasoft.Configuration.BaseLookupSchema
	{

		#region Constructors: Public

		public EmailTemplateMacros_Base_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public EmailTemplateMacros_Base_TerrasoftSchema(EmailTemplateMacros_Base_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public EmailTemplateMacros_Base_TerrasoftSchema(EmailTemplateMacros_Base_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "EmailTemplateMacros_Base_Terrasoft";
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new EmailTemplateMacros_Base_Terrasoft(userConnection) {Schema = this};
		}
		...
		public override object Clone() {
			return new EmailTemplateMacros_Base_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new EmailTemplateMacros_Base_TerrasoftSchema(this, true);
		}
	...
	#region Class: EmailTemplateMacros_Base_Terrasoft

	/// <summary>
	/// Message template macro.
	/// </summary>
	public class EmailTemplateMacros_Base_Terrasoft : Terrasoft.Configuration.BaseLookup
	{

		#region Constructors: Public

		public EmailTemplateMacros_Base_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "EmailTemplateMacros_Base_Terrasoft";
		}

		public EmailTemplateMacros_Base_Terrasoft(EmailTemplateMacros_Base_Terrasoft source)
			: base(source) {
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("EmailTemplateMacros_Base_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("EmailTemplateMacros_Base_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("EmailTemplateMacros_Base_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("EmailTemplateMacros_Base_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("EmailTemplateMacros_Base_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("EmailTemplateMacros_Base_TerrasoftSaving", e);
			Validating += (s, e) => ThrowEvent("EmailTemplateMacros_Base_TerrasoftValidating", e);
		...
		public override object Clone() {
			return new EmailTemplateMacros_Base_Terrasoft(this);
		}
	...
	/// <exclude/>
	public partial class EmailTemplateMacros_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : EmailTemplateMacros_Base_Terrasoft
	{
	...
	/// <exclude/>
	public class EmailTemplateMacros_BaseEventsProcess : EmailTemplateMacros_BaseEventsProcess<EmailTemplateMacros_Base_Terrasoft>
	{
