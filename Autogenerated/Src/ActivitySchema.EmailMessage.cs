namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Activity_EmailMessage_TerrasoftSchema : Terrasoft.Configuration.Activity_SSP_TerrasoftSchema
	{
	...
	/// Activity.
	/// </summary>
	public class Activity_EmailMessage_Terrasoft : Terrasoft.Configuration.Activity_SSP_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Activity_EmailMessage_TerrasoftDeleted", e);
	...
	/// <exclude/>
	public partial class Activity_EmailMessageEventsProcess<TEntity> : Terrasoft.Configuration.Activity_SSPEventsProcess<TEntity> where TEntity : Activity_EmailMessage_Terrasoft
	{
