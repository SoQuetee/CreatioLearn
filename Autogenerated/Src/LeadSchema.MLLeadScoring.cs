namespace Terrasoft.Configuration
{
	...
	public class Lead_MLLeadScoring_Terrasoft : Terrasoft.Configuration.Lead_Lead_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Lead_MLLeadScoring_TerrasoftDeleted", e);
	...
	/// <exclude/>
	public partial class Lead_MLLeadScoringEventsProcess<TEntity> : Terrasoft.Configuration.Lead_LeadEventsProcess<TEntity> where TEntity : Lead_MLLeadScoring_Terrasoft
	{
