namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BaseImageLookup_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : BaseImageLookup
	{
