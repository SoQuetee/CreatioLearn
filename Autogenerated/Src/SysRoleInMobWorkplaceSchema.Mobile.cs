namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysRoleInMobWorkplace_MobileEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysRoleInMobWorkplace
	{
