namespace Terrasoft.Configuration
{
	...
	public class FileExtensionSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new FileExtension_UIv2EventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class FileExtension_UIv2EventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : FileExtension
	{
	...
	public partial class FileExtension_UIv2EventsProcess<TEntity>
	{
