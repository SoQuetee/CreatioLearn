namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysSettingsFolder_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : SysSettingsFolder
	{
