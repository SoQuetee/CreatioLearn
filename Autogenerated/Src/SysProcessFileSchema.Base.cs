namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysProcessFile_BaseEventsProcess<TEntity> : Terrasoft.Configuration.File_PRMPortalEventsProcess<TEntity> where TEntity : SysProcessFile
	{
