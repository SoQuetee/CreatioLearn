namespace Terrasoft.Configuration
{
	...
	public class ActivityInFolderSchema : Terrasoft.Configuration.BaseItemInFolderSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new ActivityInFolder_BaseEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class ActivityInFolder_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : ActivityInFolder
	{
	...
	public partial class ActivityInFolder_BaseEventsProcess<TEntity>
	{
