namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class LeadFolderSchema : Terrasoft.Configuration.LeadFolder_Lead_TerrasoftSchema
	{
	...
	/// Lead folder.
	/// </summary>
	public class LeadFolder : Terrasoft.Configuration.LeadFolder_Lead_Terrasoft
	{
	...
	/// <exclude/>
	public partial class LeadFolder_PRMPortalEventsProcess<TEntity> : Terrasoft.Configuration.LeadFolder_LeadEventsProcess<TEntity> where TEntity : LeadFolder
	{
