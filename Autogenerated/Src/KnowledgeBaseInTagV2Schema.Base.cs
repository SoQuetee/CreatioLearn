namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class KnowledgeBaseInTagV2_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : KnowledgeBaseInTagV2
	{
