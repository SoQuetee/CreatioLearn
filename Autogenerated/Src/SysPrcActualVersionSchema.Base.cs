namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysPrcActualVersion_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysPrcActualVersion
	{
