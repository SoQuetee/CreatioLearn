namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Activity_Opportunity_TerrasoftSchema : Terrasoft.Configuration.Activity_OperatorSingleWindow_TerrasoftSchema
	{
	...
	/// Activity.
	/// </summary>
	public class Activity_Opportunity_Terrasoft : Terrasoft.Configuration.Activity_OperatorSingleWindow_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Activity_OpportunityEventsProcess<TEntity> : Terrasoft.Configuration.Activity_OperatorSingleWindowEventsProcess<TEntity> where TEntity : Activity_Opportunity_Terrasoft
	{
