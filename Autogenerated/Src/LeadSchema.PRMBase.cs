namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Lead_PRMBase_TerrasoftSchema : Terrasoft.Configuration.Lead_WebLeadForm_TerrasoftSchema
	{
	...
	/// Lead.
	/// </summary>
	public class Lead_PRMBase_Terrasoft : Terrasoft.Configuration.Lead_WebLeadForm_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Lead_PRMBaseEventsProcess<TEntity> : Terrasoft.Configuration.Lead_WebLeadFormEventsProcess<TEntity> where TEntity : Lead_PRMBase_Terrasoft
	{
