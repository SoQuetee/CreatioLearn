namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class DocumentSchema : Terrasoft.Configuration.Document_DocumentInContract_TerrasoftSchema
	{
	...
	/// Document.
	/// </summary>
	public class Document : Terrasoft.Configuration.Document_DocumentInContract_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Document_DocumentInProjectEventsProcess<TEntity> : Terrasoft.Configuration.Document_DocumentInContractEventsProcess<TEntity> where TEntity : Document
	{
