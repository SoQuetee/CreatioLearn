namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ContactDecisionRole_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ContactDecisionRole
	{
