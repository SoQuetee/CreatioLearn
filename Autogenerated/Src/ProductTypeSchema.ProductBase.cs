namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ProductType_ProductBaseEventsProcess<TEntity> : Terrasoft.Configuration.ProductType_BaseEventsProcess<TEntity> where TEntity : ProductType_ProductBase_Terrasoft
	{
