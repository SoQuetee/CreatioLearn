namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class Contact_SalesEnterpriseEventsProcess<TEntity> : Terrasoft.Configuration.Contact_MarketingCampaignEventsProcess<TEntity> where TEntity : Contact
	{
