namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class MLTaskStartMethodSchema : Terrasoft.Configuration.BaseLookupSchema
	{
	...
	/// MLTaskStartMethod.
	/// </summary>
	public class MLTaskStartMethod : Terrasoft.Configuration.BaseLookup
	{
	...
	/// <exclude/>
	public partial class MLTaskStartMethod_MLBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : MLTaskStartMethod
	{
