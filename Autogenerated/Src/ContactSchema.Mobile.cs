namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class Contact_MobileEventsProcess<TEntity> : Terrasoft.Configuration.Contact_BaseEventsProcess<TEntity> where TEntity : Contact_Mobile_Terrasoft
	{
