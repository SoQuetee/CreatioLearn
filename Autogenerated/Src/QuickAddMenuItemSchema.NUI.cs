namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class QuickAddMenuItem_NUIEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : QuickAddMenuItem
	{
