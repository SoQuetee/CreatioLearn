namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class SysDcmSchemaInSettingsSchema : Terrasoft.Configuration.SysDcmSchemaInSettings_Base_TerrasoftSchema
	{
	...
	/// </summary>
	public class SysDcmSchemaInSettings : Terrasoft.Configuration.SysDcmSchemaInSettings_Base_Terrasoft
	{
	...
	/// <exclude/>
	public partial class SysDcmSchemaInSettings_PRMPortalEventsProcess<TEntity> : Terrasoft.Configuration.SysDcmSchemaInSettings_BaseEventsProcess<TEntity> where TEntity : SysDcmSchemaInSettings
	{
