namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysAdminOperationFolder_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : SysAdminOperationFolder
	{
