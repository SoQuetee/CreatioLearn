namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CampaignLogItemType_CampaignsEventsProcess<TEntity> : Terrasoft.Configuration.Lookup_BaseEventsProcess<TEntity> where TEntity : CampaignLogItemType
	{
