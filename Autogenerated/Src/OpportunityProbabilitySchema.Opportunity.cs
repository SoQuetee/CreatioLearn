namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class OpportunityProbability_OpportunityEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : OpportunityProbability
	{
