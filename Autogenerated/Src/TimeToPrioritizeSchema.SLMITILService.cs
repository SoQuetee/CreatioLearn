namespace Terrasoft.Configuration
{
	...
	public class TimeToPrioritizeSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new TimeToPrioritize_SLMITILServiceEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class TimeToPrioritize_SLMITILServiceEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : TimeToPrioritize
	{
	...
	public partial class TimeToPrioritize_SLMITILServiceEventsProcess<TEntity>
	{
