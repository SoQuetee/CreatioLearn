namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ProductSource_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseImageLookup_BaseEventsProcess<TEntity> where TEntity : ProductSource
	{
