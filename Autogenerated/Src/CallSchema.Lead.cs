namespace Terrasoft.Configuration
{
	...
	public class Call_Lead_Terrasoft : Terrasoft.Configuration.Call_Base_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Call_Lead_TerrasoftDeleted", e);
	...
	/// <exclude/>
	public partial class Call_LeadEventsProcess<TEntity> : Terrasoft.Configuration.Call_BaseEventsProcess<TEntity> where TEntity : Call_Lead_Terrasoft
	{
