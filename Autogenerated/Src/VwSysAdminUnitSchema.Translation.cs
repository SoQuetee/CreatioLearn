namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class VwSysAdminUnit_Translation_TerrasoftSchema : Terrasoft.Configuration.VwSysAdminUnit_Base_TerrasoftSchema
	{
	...
	/// Users/roles (view).
	/// </summary>
	public class VwSysAdminUnit_Translation_Terrasoft : Terrasoft.Configuration.VwSysAdminUnit_Base_Terrasoft
	{
	...
	/// <exclude/>
	public partial class VwSysAdminUnit_TranslationEventsProcess<TEntity> : Terrasoft.Configuration.VwSysAdminUnit_BaseEventsProcess<TEntity> where TEntity : VwSysAdminUnit_Translation_Terrasoft
	{
