namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysFileMetadataStorage_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : SysFileMetadataStorage
	{
