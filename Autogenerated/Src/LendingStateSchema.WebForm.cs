namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class LendingState_WebFormEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : LendingState
	{
