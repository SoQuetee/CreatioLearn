namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysEntityOperation_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : SysEntityOperation
	{
