namespace Terrasoft.Configuration
{
	...
	public class SocialChannelInFolderSchema : Terrasoft.Configuration.BaseItemInFolderSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new SocialChannelInFolder_ESNEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class SocialChannelInFolder_ESNEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : SocialChannelInFolder
	{
	...
	public partial class SocialChannelInFolder_ESNEventsProcess<TEntity>
	{
