namespace Terrasoft.Configuration
{
	...
	public class VwAccountRelationshipSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new VwAccountRelationship_NUIEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class VwAccountRelationship_NUIEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : VwAccountRelationship
	{
