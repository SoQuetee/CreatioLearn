namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BulkEmailPriority_BulkEmailEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : BulkEmailPriority
	{
