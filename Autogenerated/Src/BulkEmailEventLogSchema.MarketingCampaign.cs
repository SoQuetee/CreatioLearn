namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class BulkEmailEventLogSchema : Terrasoft.Configuration.BaseLookupSchema
	{
	...
	/// Mailing log.
	/// </summary>
	public class BulkEmailEventLog : Terrasoft.Configuration.BaseLookup
	{
	...
	/// <exclude/>
	public partial class BulkEmailEventLog_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : BulkEmailEventLog
	{
