namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class ContactSalutationTypeSchema : Terrasoft.Configuration.ContactSalutationType_Base_TerrasoftSchema
	{
	...
	/// Contact title.
	/// </summary>
	public class ContactSalutationType : Terrasoft.Configuration.ContactSalutationType_Base_Terrasoft
	{
	...
	/// <exclude/>
	public partial class ContactSalutationType_SSPEventsProcess<TEntity> : Terrasoft.Configuration.ContactSalutationType_BaseEventsProcess<TEntity> where TEntity : ContactSalutationType
	{
