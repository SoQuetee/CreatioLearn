namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ServiceItemFolder_SLMEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : ServiceItemFolder
	{
