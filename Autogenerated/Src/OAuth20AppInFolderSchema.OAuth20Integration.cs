namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class OAuth20AppInFolder_OAuth20IntegrationEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : OAuth20AppInFolder
	{
