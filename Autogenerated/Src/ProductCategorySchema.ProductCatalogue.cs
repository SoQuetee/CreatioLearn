namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ProductCategory_ProductCatalogueEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ProductCategory
	{
