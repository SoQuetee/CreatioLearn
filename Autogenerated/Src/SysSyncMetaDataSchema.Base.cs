namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysSyncMetaData_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysSyncMetaData
	{
