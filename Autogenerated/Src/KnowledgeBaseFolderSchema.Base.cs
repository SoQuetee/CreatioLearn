namespace Terrasoft.Configuration
{
	...
	public class KnowledgeBaseFolderSchema : Terrasoft.Configuration.BaseFolderSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new KnowledgeBaseFolder_BaseEventsProcess(userConnection);
		}
	...
	public class KnowledgeBaseFolder : Terrasoft.Configuration.BaseFolder
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new KnowledgeBaseFolder_BaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: KnowledgeBaseFolder_BaseEventsProcess

	/// <exclude/>
	public partial class KnowledgeBaseFolder_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : KnowledgeBaseFolder
	{

		public KnowledgeBaseFolder_BaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "KnowledgeBaseFolder_BaseEventsProcess";
	...
	/// <exclude/>
	public class KnowledgeBaseFolder_BaseEventsProcess : KnowledgeBaseFolder_BaseEventsProcess<KnowledgeBaseFolder>
	{
	...
	public partial class KnowledgeBaseFolder_BaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class KnowledgeBaseFolderEventsProcess : KnowledgeBaseFolder_BaseEventsProcess
	{
