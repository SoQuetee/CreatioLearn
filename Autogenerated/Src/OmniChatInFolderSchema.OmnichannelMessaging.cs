namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class OmniChatInFolder_OmnichannelMessagingEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : OmniChatInFolder
	{
