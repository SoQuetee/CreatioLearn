namespace Terrasoft.Configuration
{
	...
	public class SysAdminUnitInFolderSchema : Terrasoft.Configuration.BaseItemInFolderSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new SysAdminUnitInFolder_BaseEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class SysAdminUnitInFolder_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : SysAdminUnitInFolder
	{
	...
	public partial class SysAdminUnitInFolder_BaseEventsProcess<TEntity>
	{
