namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwSysSchemaDataInPackage_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : VwSysSchemaDataInPackage
	{
