namespace Terrasoft.Configuration
{
	...
	public class Activity_NUI_Terrasoft : Terrasoft.Configuration.Activity_Base_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Activity_NUI_TerrasoftDeleted", e);
	...
	/// <exclude/>
	public partial class Activity_NUIEventsProcess<TEntity> : Terrasoft.Configuration.Activity_BaseEventsProcess<TEntity> where TEntity : Activity_NUI_Terrasoft
	{
