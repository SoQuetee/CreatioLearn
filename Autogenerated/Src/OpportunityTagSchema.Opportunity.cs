namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class OpportunityTag_OpportunityEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : OpportunityTag_Opportunity_Terrasoft
	{
