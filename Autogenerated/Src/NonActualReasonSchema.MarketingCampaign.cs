namespace Terrasoft.Configuration
{
	...
	public class NonActualReasonSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new NonActualReason_MarketingCampaignEventsProcess(userConnection);
		}
	...
	public class NonActualReason : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new NonActualReason_MarketingCampaignEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: NonActualReason_MarketingCampaignEventsProcess

	/// <exclude/>
	public partial class NonActualReason_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : NonActualReason
	{

		public NonActualReason_MarketingCampaignEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "NonActualReason_MarketingCampaignEventsProcess";
	...
	/// <exclude/>
	public class NonActualReason_MarketingCampaignEventsProcess : NonActualReason_MarketingCampaignEventsProcess<NonActualReason>
	{
	...
	public partial class NonActualReason_MarketingCampaignEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class NonActualReasonEventsProcess : NonActualReason_MarketingCampaignEventsProcess
	{
