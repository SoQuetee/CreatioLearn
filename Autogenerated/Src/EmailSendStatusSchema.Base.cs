namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class EmailSendStatus_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : EmailSendStatus
	{
