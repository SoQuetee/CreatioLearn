namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ProblemInFolder_ProblemEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : ProblemInFolder
	{
