namespace Terrasoft.Configuration
{
	...
	public class RegisterMethodSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new RegisterMethod_TouchPointsEventsProcess(userConnection);
		}
	...
	public class RegisterMethod : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new RegisterMethod_TouchPointsEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: RegisterMethod_TouchPointsEventsProcess

	/// <exclude/>
	public partial class RegisterMethod_TouchPointsEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : RegisterMethod
	{

		public RegisterMethod_TouchPointsEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "RegisterMethod_TouchPointsEventsProcess";
	...
	/// <exclude/>
	public class RegisterMethod_TouchPointsEventsProcess : RegisterMethod_TouchPointsEventsProcess<RegisterMethod>
	{
	...
	public partial class RegisterMethod_TouchPointsEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class RegisterMethodEventsProcess : RegisterMethod_TouchPointsEventsProcess
	{
