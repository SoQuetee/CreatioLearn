namespace Terrasoft.Configuration
{
	...
	public class VwRemindingsCountSchema : Terrasoft.Core.Entities.EntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new VwRemindingsCount_NUIEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class VwRemindingsCount_NUIEventsProcess<TEntity> : Terrasoft.Core.Process.EmbeddedProcess where TEntity : VwRemindingsCount
	{
	...
	public partial class VwRemindingsCount_NUIEventsProcess<TEntity>
	{
