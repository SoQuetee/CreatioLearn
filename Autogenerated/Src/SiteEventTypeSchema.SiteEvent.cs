namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SiteEventType_SiteEventEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : SiteEventType_SiteEvent_Terrasoft
	{
