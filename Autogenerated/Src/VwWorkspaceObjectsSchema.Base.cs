namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwWorkspaceObjects_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : VwWorkspaceObjects
	{
