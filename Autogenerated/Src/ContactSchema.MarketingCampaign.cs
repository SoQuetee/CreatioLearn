namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Contact_MarketingCampaign_TerrasoftSchema : Terrasoft.Configuration.Contact_SSP_TerrasoftSchema
	{
	...
	/// Contact.
	/// </summary>
	public class Contact_MarketingCampaign_Terrasoft : Terrasoft.Configuration.Contact_SSP_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Contact_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.Contact_SSPEventsProcess<TEntity> where TEntity : Contact_MarketingCampaign_Terrasoft
	{
