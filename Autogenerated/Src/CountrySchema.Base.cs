namespace Terrasoft.Configuration
{
	...
	public class Country_Base_Terrasoft : Terrasoft.Configuration.BaseImageLookup
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Country_Base_TerrasoftDeleted", e);
	...
	/// <exclude/>
	public partial class Country_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseImageLookup_BaseEventsProcess<TEntity> where TEntity : Country_Base_Terrasoft
	{
