namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ParticipantResponse_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : ParticipantResponse
	{
