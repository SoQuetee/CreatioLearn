namespace Terrasoft.Configuration
{
	...
	#region Class: CommunicationType_Base_TerrasoftSchema

	/// <exclude/>
	public class CommunicationType_Base_TerrasoftSchema : Terrasoft.Configuration.BaseImageLookupSchema
	{

		#region Constructors: Public

		public CommunicationType_Base_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public CommunicationType_Base_TerrasoftSchema(CommunicationType_Base_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public CommunicationType_Base_TerrasoftSchema(CommunicationType_Base_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "CommunicationType_Base_Terrasoft";
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new CommunicationType_Base_Terrasoft(userConnection) {Schema = this};
		}
		...
		public override object Clone() {
			return new CommunicationType_Base_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new CommunicationType_Base_TerrasoftSchema(this, true);
		}
	...
	#region Class: CommunicationType_Base_Terrasoft

	/// <summary>
	/// Communication option type.
	/// </summary>
	public class CommunicationType_Base_Terrasoft : Terrasoft.Configuration.BaseImageLookup
	{

		#region Constructors: Public

		public CommunicationType_Base_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "CommunicationType_Base_Terrasoft";
		}

		public CommunicationType_Base_Terrasoft(CommunicationType_Base_Terrasoft source)
			: base(source) {
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("CommunicationType_Base_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("CommunicationType_Base_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("CommunicationType_Base_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("CommunicationType_Base_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("CommunicationType_Base_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("CommunicationType_Base_TerrasoftSaving", e);
			Validating += (s, e) => ThrowEvent("CommunicationType_Base_TerrasoftValidating", e);
		...
		public override object Clone() {
			return new CommunicationType_Base_Terrasoft(this);
		}
	...
	/// <exclude/>
	public partial class CommunicationType_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseImageLookup_BaseEventsProcess<TEntity> where TEntity : CommunicationType_Base_Terrasoft
	{
	...
	/// <exclude/>
	public class CommunicationType_BaseEventsProcess : CommunicationType_BaseEventsProcess<CommunicationType_Base_Terrasoft>
	{
