namespace Terrasoft.Configuration
{
	...
	#region Class: FileLead_Lead_TerrasoftSchema

	/// <exclude/>
	public class FileLead_Lead_TerrasoftSchema : Terrasoft.Configuration.FileSchema
	{

		#region Constructors: Public

		public FileLead_Lead_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public FileLead_Lead_TerrasoftSchema(FileLead_Lead_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public FileLead_Lead_TerrasoftSchema(FileLead_Lead_TerrasoftSchema source)
			: base(source) {
		}
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new FileLead_Lead_Terrasoft(userConnection) {Schema = this};
		}
		...
		public override object Clone() {
			return new FileLead_Lead_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new FileLead_Lead_TerrasoftSchema(this, true);
		}
	...
	#region Class: FileLead_Lead_Terrasoft

	/// <summary>
	/// Lead attachment.
	/// </summary>
	public class FileLead_Lead_Terrasoft : Terrasoft.Configuration.File
	{
		...
		public FileLead_Lead_Terrasoft(FileLead_Lead_Terrasoft source)
			: base(source) {
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("FileLead_Lead_TerrasoftDeleted", e);
			Updated += (s, e) => ThrowEvent("FileLead_Lead_TerrasoftUpdated", e);
		...
		public override object Clone() {
			return new FileLead_Lead_Terrasoft(this);
		}
	...
	/// <exclude/>
	public partial class FileLead_LeadEventsProcess<TEntity> : Terrasoft.Configuration.File_PRMPortalEventsProcess<TEntity> where TEntity : FileLead_Lead_Terrasoft
	{
	...
	/// <exclude/>
	public class FileLead_LeadEventsProcess : FileLead_LeadEventsProcess<FileLead_Lead_Terrasoft>
	{
