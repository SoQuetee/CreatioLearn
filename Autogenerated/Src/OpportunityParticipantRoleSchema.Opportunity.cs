namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class OpportunityParticipantRoleSchema : Terrasoft.Configuration.BaseLookupSchema
	{
	...
	/// <summary>
	/// Opportunity participant role.
	/// </summary>
	public class OpportunityParticipantRole : Terrasoft.Configuration.BaseLookup
	{
	...
	/// <exclude/>
	public partial class OpportunityParticipantRole_OpportunityEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : OpportunityParticipantRole
	{
