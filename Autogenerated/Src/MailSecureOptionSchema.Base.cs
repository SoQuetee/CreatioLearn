namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class MailSecureOption_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : MailSecureOption
	{
