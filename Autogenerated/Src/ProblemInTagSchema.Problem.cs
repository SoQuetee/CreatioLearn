namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ProblemInTag_ProblemEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : ProblemInTag
	{
