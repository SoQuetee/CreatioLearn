namespace Terrasoft.Configuration
{
	...
	public class SysPrcElMIHistoryLogSchema : Terrasoft.Configuration.SysPrcElMILogSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new SysPrcElMIHistoryLog_BaseEventsProcess(userConnection);
		}
	...
	public class SysPrcElMIHistoryLog : Terrasoft.Configuration.SysPrcElMILog
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new SysPrcElMIHistoryLog_BaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: SysPrcElMIHistoryLog_BaseEventsProcess

	/// <exclude/>
	public partial class SysPrcElMIHistoryLog_BaseEventsProcess<TEntity> : Terrasoft.Configuration.SysPrcElMILog_BaseEventsProcess<TEntity> where TEntity : SysPrcElMIHistoryLog
	{

		public SysPrcElMIHistoryLog_BaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "SysPrcElMIHistoryLog_BaseEventsProcess";
	...
	/// <exclude/>
	public class SysPrcElMIHistoryLog_BaseEventsProcess : SysPrcElMIHistoryLog_BaseEventsProcess<SysPrcElMIHistoryLog>
	{
	...
	public partial class SysPrcElMIHistoryLog_BaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class SysPrcElMIHistoryLogEventsProcess : SysPrcElMIHistoryLog_BaseEventsProcess
	{
