namespace Terrasoft.Configuration
{
	...
	#region Class: ActivityParticipant_Base_TerrasoftSchema

	/// <exclude/>
	public class ActivityParticipant_Base_TerrasoftSchema : Terrasoft.Configuration.BaseEntitySchema
	{

		#region Constructors: Public

		public ActivityParticipant_Base_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public ActivityParticipant_Base_TerrasoftSchema(ActivityParticipant_Base_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public ActivityParticipant_Base_TerrasoftSchema(ActivityParticipant_Base_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "ActivityParticipant_Base_Terrasoft";
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new ActivityParticipant_Base_Terrasoft(userConnection) {Schema = this};
		}

		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new ActivityParticipant_BaseEventsProcess(userConnection);
		}

		public override object Clone() {
			return new ActivityParticipant_Base_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new ActivityParticipant_Base_TerrasoftSchema(this, true);
		}
	...
	#region Class: ActivityParticipant_Base_Terrasoft

	/// <summary>
	/// Activity participant.
	/// </summary>
	public class ActivityParticipant_Base_Terrasoft : Terrasoft.Configuration.BaseEntity
	{

		#region Constructors: Public

		public ActivityParticipant_Base_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "ActivityParticipant_Base_Terrasoft";
		}

		public ActivityParticipant_Base_Terrasoft(ActivityParticipant_Base_Terrasoft source)
			: base(source) {
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("ActivityParticipant_Base_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("ActivityParticipant_Base_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("ActivityParticipant_Base_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("ActivityParticipant_Base_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("ActivityParticipant_Base_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("ActivityParticipant_Base_TerrasoftSaving", e);
			Validating += (s, e) => ThrowEvent("ActivityParticipant_Base_TerrasoftValidating", e);
		...
		public override object Clone() {
			return new ActivityParticipant_Base_Terrasoft(this);
		}
	...
	/// <exclude/>
	public partial class ActivityParticipant_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : ActivityParticipant_Base_Terrasoft
	{
		...
		public override void ThrowEvent(ProcessExecutingContext context, string message) {
			switch(message) {
					...
					case "ActivityParticipant_Base_TerrasoftSaved":
						...
						break;
					case "ActivityParticipant_Base_TerrasoftInserting":
	...
	/// <exclude/>
	public class ActivityParticipant_BaseEventsProcess : ActivityParticipant_BaseEventsProcess<ActivityParticipant_Base_Terrasoft>
	{
	...
	public partial class ActivityParticipant_BaseEventsProcess<TEntity>
	{
