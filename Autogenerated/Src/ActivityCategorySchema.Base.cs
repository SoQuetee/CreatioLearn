namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ActivityCategory_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ActivityCategory
	{
