namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwSysPackages_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : VwSysPackages
	{
