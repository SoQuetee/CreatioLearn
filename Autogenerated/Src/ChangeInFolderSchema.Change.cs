namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ChangeInFolder_ChangeEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : ChangeInFolder
	{
