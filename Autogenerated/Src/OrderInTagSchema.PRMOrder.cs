namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class OrderInTagSchema : Terrasoft.Configuration.OrderInTag_Order_TerrasoftSchema
	{
	...
	/// </summary>
	public class OrderInTag : Terrasoft.Configuration.OrderInTag_Order_Terrasoft
	{
	...
	/// <exclude/>
	public partial class OrderInTag_PRMOrderEventsProcess<TEntity> : Terrasoft.Configuration.OrderInTag_OrderEventsProcess<TEntity> where TEntity : OrderInTag
	{
