namespace Terrasoft.Configuration
{
	...
	public class MLModelColumnTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new MLModelColumnType_MLEventsProcess(userConnection);
		}
	...
	public class MLModelColumnType : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new MLModelColumnType_MLEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: MLModelColumnType_MLEventsProcess

	/// <exclude/>
	public partial class MLModelColumnType_MLEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : MLModelColumnType
	{

		public MLModelColumnType_MLEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "MLModelColumnType_MLEventsProcess";
	...
	/// <exclude/>
	public class MLModelColumnType_MLEventsProcess : MLModelColumnType_MLEventsProcess<MLModelColumnType>
	{
	...
	public partial class MLModelColumnType_MLEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class MLModelColumnTypeEventsProcess : MLModelColumnType_MLEventsProcess
	{
