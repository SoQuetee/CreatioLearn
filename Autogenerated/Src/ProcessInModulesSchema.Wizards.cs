namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ProcessInModules_WizardsEventsProcess<TEntity> : Terrasoft.Configuration.ProcessInModules_BaseEventsProcess<TEntity> where TEntity : ProcessInModules
	{
