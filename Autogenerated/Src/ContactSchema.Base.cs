namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class Contact_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : Contact_Base_Terrasoft
	{
