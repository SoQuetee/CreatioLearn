namespace Terrasoft.Configuration
{
	...
	public class CallInTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new CallInTag_BaseEventsProcess(userConnection);
		}
	...
	public class CallInTag : Terrasoft.Configuration.BaseEntityInTag
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new CallInTag_BaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: CallInTag_BaseEventsProcess

	/// <exclude/>
	public partial class CallInTag_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : CallInTag
	{

		public CallInTag_BaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "CallInTag_BaseEventsProcess";
	...
	/// <exclude/>
	public class CallInTag_BaseEventsProcess : CallInTag_BaseEventsProcess<CallInTag>
	{
	...
	public partial class CallInTag_BaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class CallInTagEventsProcess : CallInTag_BaseEventsProcess
	{
