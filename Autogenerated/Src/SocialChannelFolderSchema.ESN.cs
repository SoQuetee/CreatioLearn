namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SocialChannelFolder_ESNEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : SocialChannelFolder
	{
