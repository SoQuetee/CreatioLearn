namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SyncErrorMessage_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : SyncErrorMessage
	{
