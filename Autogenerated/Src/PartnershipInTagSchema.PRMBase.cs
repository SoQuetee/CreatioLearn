namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class PartnershipInTag_PRMBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : PartnershipInTag_PRMBase_Terrasoft
	{
