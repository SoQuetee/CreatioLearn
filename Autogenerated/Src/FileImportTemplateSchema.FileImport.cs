namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class FileImportTemplate_FileImportEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : FileImportTemplate
	{
