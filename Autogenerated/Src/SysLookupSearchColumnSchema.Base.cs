namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysLookupSearchColumn_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysLookupSearchColumn
	{
