namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class WSysAccountInTag_WebitelCollaborationsEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : WSysAccountInTag
	{
