namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ServiceItem_SLMITILServiceEventsProcess<TEntity> : Terrasoft.Configuration.ServiceItem_SLMEventsProcess<TEntity> where TEntity : ServiceItem
	{
