namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ConfItemInTag_CMDBEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : ConfItemInTag
	{
