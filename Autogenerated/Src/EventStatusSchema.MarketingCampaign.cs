namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class EventStatus_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : EventStatus
	{
