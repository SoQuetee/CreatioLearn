namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class HTTPAuthType_ProcessDesignerEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : HTTPAuthType
	{
