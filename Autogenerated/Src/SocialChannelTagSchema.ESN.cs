namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SocialChannelTag_ESNEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : SocialChannelTag
	{
