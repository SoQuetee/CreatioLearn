namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class EntitySchemaRecRightOperationSchema : Terrasoft.Configuration.BaseValueLookupSchema
	{
	...
	/// </summary>
	public class EntitySchemaRecRightOperation : Terrasoft.Configuration.BaseValueLookup
	{
	...
	/// <exclude/>
	public partial class EntitySchemaRecRightOperation_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseValueLookup_BaseEventsProcess<TEntity> where TEntity : EntitySchemaRecRightOperation
	{
