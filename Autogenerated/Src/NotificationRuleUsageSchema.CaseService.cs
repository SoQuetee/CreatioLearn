namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class NotificationRuleUsage_CaseServiceEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : NotificationRuleUsage
	{
