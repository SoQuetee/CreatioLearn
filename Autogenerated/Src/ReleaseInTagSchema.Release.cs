namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ReleaseInTag_ReleaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : ReleaseInTag
	{
