namespace Terrasoft.Configuration
{
	...
	public class ContactFileSchema : Terrasoft.Configuration.FileSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new ContactFile_BaseEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class ContactFile_BaseEventsProcess<TEntity> : Terrasoft.Configuration.File_PRMPortalEventsProcess<TEntity> where TEntity : ContactFile
	{
