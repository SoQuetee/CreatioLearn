namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysAdminUnit_LDAPEventsProcess<TEntity> : Terrasoft.Configuration.SysAdminUnit_TranslationEventsProcess<TEntity> where TEntity : SysAdminUnit_LDAP_Terrasoft
	{
