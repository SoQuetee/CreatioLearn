namespace Terrasoft.Configuration
{
	...
	#region Class: CaseFile_Case_TerrasoftSchema

	/// <exclude/>
	public class CaseFile_Case_TerrasoftSchema : Terrasoft.Configuration.FileSchema
	{

		#region Constructors: Public

		public CaseFile_Case_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public CaseFile_Case_TerrasoftSchema(CaseFile_Case_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public CaseFile_Case_TerrasoftSchema(CaseFile_Case_TerrasoftSchema source)
			: base(source) {
		}
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new CaseFile_Case_Terrasoft(userConnection) {Schema = this};
		}
		...
		public override object Clone() {
			return new CaseFile_Case_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new CaseFile_Case_TerrasoftSchema(this, true);
		}
	...
	#region Class: CaseFile_Case_Terrasoft

	/// <summary>
	/// Attachments and notes detail object in Cases section.
	/// </summary>
	public class CaseFile_Case_Terrasoft : Terrasoft.Configuration.File
	{

		#region Constructors: Public

		public CaseFile_Case_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "CaseFile_Case_Terrasoft";
		}

		public CaseFile_Case_Terrasoft(CaseFile_Case_Terrasoft source)
			: base(source) {
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("CaseFile_Case_TerrasoftDeleted", e);
			Updated += (s, e) => ThrowEvent("CaseFile_Case_TerrasoftUpdated", e);
		...
		public override object Clone() {
			return new CaseFile_Case_Terrasoft(this);
		}
	...
	/// <exclude/>
	public partial class CaseFile_CaseEventsProcess<TEntity> : Terrasoft.Configuration.File_PRMPortalEventsProcess<TEntity> where TEntity : CaseFile_Case_Terrasoft
	{
	...
	/// <exclude/>
	public class CaseFile_CaseEventsProcess : CaseFile_CaseEventsProcess<CaseFile_Case_Terrasoft>
	{
