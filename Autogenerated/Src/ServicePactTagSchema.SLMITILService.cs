namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ServicePactTag_SLMITILServiceEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : ServicePactTag
	{
