namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class DeduplicateOperation_DeduplicationEventsProcess<TEntity> : Terrasoft.Configuration.Lookup_BaseEventsProcess<TEntity> where TEntity : DeduplicateOperation
	{
