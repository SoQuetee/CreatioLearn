namespace Terrasoft.Configuration
{
	...
	public class OrderInFolder_Order_Terrasoft : Terrasoft.Configuration.BaseItemInFolder
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("OrderInFolder_Order_TerrasoftDeleted", e);
	...
	/// <exclude/>
	public partial class OrderInFolder_OrderEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : OrderInFolder_Order_Terrasoft
	{
