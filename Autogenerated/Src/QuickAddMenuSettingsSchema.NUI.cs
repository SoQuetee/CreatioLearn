namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class QuickAddMenuSettings_NUIEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : QuickAddMenuSettings
	{
