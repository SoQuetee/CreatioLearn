namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BulkEmailInFolder_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : BulkEmailInFolder
	{
