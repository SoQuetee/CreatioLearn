namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class UnitForCalculation_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : UnitForCalculation
	{
