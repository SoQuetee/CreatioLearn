namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SupplyPaymentTemplate_PassportEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : SupplyPaymentTemplate
	{
