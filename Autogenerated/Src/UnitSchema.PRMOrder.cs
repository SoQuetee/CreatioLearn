namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class UnitSchema : Terrasoft.Configuration.Unit_Base_TerrasoftSchema
	{
	...
	/// Units of Measure.
	/// </summary>
	public class Unit : Terrasoft.Configuration.Unit_Base_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Unit_PRMOrderEventsProcess<TEntity> : Terrasoft.Configuration.Unit_BaseEventsProcess<TEntity> where TEntity : Unit
	{
