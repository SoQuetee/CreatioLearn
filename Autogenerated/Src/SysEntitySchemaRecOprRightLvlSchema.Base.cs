namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysEntitySchemaRecOprRightLvl_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : SysEntitySchemaRecOprRightLvl
	{
