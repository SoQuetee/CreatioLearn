namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SupportLevel_CaseServiceEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : SupportLevel
	{
