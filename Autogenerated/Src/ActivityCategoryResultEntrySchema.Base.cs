namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ActivityCategoryResultEntry_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : ActivityCategoryResultEntry
	{
