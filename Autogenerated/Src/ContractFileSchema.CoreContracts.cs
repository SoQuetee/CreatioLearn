namespace Terrasoft.Configuration
{
	...
	public class ContractFileSchema : Terrasoft.Configuration.FileSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new ContractFile_CoreContractsEventsProcess(userConnection);
		}
	...
	public class ContractFile : Terrasoft.Configuration.File
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new ContractFile_CoreContractsEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: ContractFile_CoreContractsEventsProcess

	/// <exclude/>
	public partial class ContractFile_CoreContractsEventsProcess<TEntity> : Terrasoft.Configuration.File_PRMPortalEventsProcess<TEntity> where TEntity : ContractFile
	{

		public ContractFile_CoreContractsEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "ContractFile_CoreContractsEventsProcess";
	...
	/// <exclude/>
	public class ContractFile_CoreContractsEventsProcess : ContractFile_CoreContractsEventsProcess<ContractFile>
	{
	...
	public partial class ContractFile_CoreContractsEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class ContractFileEventsProcess : ContractFile_CoreContractsEventsProcess
	{
