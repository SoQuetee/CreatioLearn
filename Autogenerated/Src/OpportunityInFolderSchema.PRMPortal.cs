namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class OpportunityInFolderSchema : Terrasoft.Configuration.OpportunityInFolder_Opportunity_TerrasoftSchema
	{
	...
	/// </summary>
	public class OpportunityInFolder : Terrasoft.Configuration.OpportunityInFolder_Opportunity_Terrasoft
	{
	...
	/// <exclude/>
	public partial class OpportunityInFolder_PRMPortalEventsProcess<TEntity> : Terrasoft.Configuration.OpportunityInFolder_OpportunityEventsProcess<TEntity> where TEntity : OpportunityInFolder
	{
