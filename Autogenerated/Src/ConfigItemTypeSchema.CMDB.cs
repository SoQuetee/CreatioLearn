namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ConfigItemType_CMDBEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ConfigItemType
	{
