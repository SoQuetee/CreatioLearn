namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CampaignSignalEntity_CampaignElementsEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : CampaignSignalEntity
	{
