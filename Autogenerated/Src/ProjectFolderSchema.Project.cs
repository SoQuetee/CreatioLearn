namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ProjectFolder_ProjectEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : ProjectFolder
	{
