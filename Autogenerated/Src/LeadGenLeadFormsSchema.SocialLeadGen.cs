namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class LeadGenLeadForms_SocialLeadGenEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : LeadGenLeadForms
	{
