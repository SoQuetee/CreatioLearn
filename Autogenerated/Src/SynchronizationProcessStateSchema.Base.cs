namespace Terrasoft.Configuration
{
	...
	public class SynchronizationProcessStateSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new SynchronizationProcessState_BaseEventsProcess(userConnection);
		}
	...
	public class SynchronizationProcessState : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new SynchronizationProcessState_BaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: SynchronizationProcessState_BaseEventsProcess

	/// <exclude/>
	public partial class SynchronizationProcessState_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : SynchronizationProcessState
	{

		public SynchronizationProcessState_BaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "SynchronizationProcessState_BaseEventsProcess";
	...
	/// <exclude/>
	public class SynchronizationProcessState_BaseEventsProcess : SynchronizationProcessState_BaseEventsProcess<SynchronizationProcessState>
	{
	...
	public partial class SynchronizationProcessState_BaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class SynchronizationProcessStateEventsProcess : SynchronizationProcessState_BaseEventsProcess
	{
