namespace Terrasoft.Configuration
{
	...
	public class AccountTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new AccountTag_BaseEventsProcess(userConnection);
		}
	...
	public class AccountTag : Terrasoft.Configuration.BaseTag
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new AccountTag_BaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: AccountTag_BaseEventsProcess

	/// <exclude/>
	public partial class AccountTag_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : AccountTag
	{

		public AccountTag_BaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "AccountTag_BaseEventsProcess";
	...
	/// <exclude/>
	public class AccountTag_BaseEventsProcess : AccountTag_BaseEventsProcess<AccountTag>
	{
	...
	public partial class AccountTag_BaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class AccountTagEventsProcess : AccountTag_BaseEventsProcess
	{
