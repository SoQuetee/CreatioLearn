namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class OppContactMotivatType_OpportunityEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : OppContactMotivatType
	{
