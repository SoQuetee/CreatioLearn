namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class LeadGenSyncLog_SocialLeadGenEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : LeadGenSyncLog
	{
