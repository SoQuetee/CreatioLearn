namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysModulePrimaryGrid_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysModulePrimaryGrid
	{
