namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ForecastColumnType_CoreForecastEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : ForecastColumnType
	{
