namespace Terrasoft.Configuration
{
	...
	public class CaseSequenceServiceSchema : Terrasoft.Core.SourceCodeSchema
	{
		...
		protected override void InitializeProperties() {
			...
			ZipBody = new byte[] { 31,139,8,0,0,0,0,0,4,0,203,75,204,77,45,46,72,76,78,85,8,73,45,42,74,44,206,79,43,209,115,206,207,75,203,76,47,45,74,44,201,204,207,211,115,78,44,78,13,78,45,44,77,205,75,6,210,69,101,153,201,169,188,92,213,188,92,181,0,247,254,53,156,59,0,0,0 };
		}
