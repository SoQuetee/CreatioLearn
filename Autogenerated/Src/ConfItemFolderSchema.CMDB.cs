namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ConfItemFolder_CMDBEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : ConfItemFolder
	{
