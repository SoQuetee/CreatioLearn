namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class LDAPAuthType_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseValueLookup_BaseEventsProcess<TEntity> where TEntity : LDAPAuthType
	{
