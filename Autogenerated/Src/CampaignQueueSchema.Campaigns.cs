namespace Terrasoft.Configuration
{
	...
	public class CampaignQueueSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new CampaignQueue_CampaignsEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class CampaignQueue_CampaignsEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : CampaignQueue
	{
	...
	public partial class CampaignQueue_CampaignsEventsProcess<TEntity>
	{
