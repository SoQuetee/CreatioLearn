namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysWidgetDashboard_BaseEventsProcess<TEntity> : Terrasoft.Configuration.SysDashboard_PortalEventsProcess<TEntity> where TEntity : SysWidgetDashboard
	{
