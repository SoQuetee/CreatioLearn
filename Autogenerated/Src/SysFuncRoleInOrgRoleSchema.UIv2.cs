namespace Terrasoft.Configuration
{
	...
	public class SysFuncRoleInOrgRoleSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new SysFuncRoleInOrgRole_UIv2EventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class SysFuncRoleInOrgRole_UIv2EventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysFuncRoleInOrgRole
	{
	...
	public partial class SysFuncRoleInOrgRole_UIv2EventsProcess<TEntity>
	{
