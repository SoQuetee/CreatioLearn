namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class File_LinkPreviewEventsProcess<TEntity> : Terrasoft.Configuration.File_BaseEventsProcess<TEntity> where TEntity : File_LinkPreview_Terrasoft
	{
