namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class OpportunityChannel_OpportunityEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : OpportunityChannel
	{
