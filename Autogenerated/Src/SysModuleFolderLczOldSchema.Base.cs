namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysModuleFolderLczOld_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLczEntity_BaseEventsProcess<TEntity> where TEntity : SysModuleFolderLczOld
	{
