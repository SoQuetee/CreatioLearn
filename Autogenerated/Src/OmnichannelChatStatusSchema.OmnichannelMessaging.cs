namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class OmnichannelChatStatus_OmnichannelMessagingEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : OmnichannelChatStatus
	{
