namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class LeadMediumCode_TouchPointsEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : LeadMediumCode
	{
