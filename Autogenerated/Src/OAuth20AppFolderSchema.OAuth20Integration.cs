namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class OAuth20AppFolder_OAuth20IntegrationEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : OAuth20AppFolder
	{
