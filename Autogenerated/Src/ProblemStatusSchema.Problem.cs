namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ProblemStatus_ProblemEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ProblemStatus
	{
