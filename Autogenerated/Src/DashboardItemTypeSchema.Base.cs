namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class DashboardItemType_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : DashboardItemType
	{
