namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Activity_SSP_TerrasoftSchema : Terrasoft.Configuration.Activity_Lead_TerrasoftSchema
	{
	...
	/// Activity.
	/// </summary>
	public class Activity_SSP_Terrasoft : Terrasoft.Configuration.Activity_Lead_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Activity_SSPEventsProcess<TEntity> : Terrasoft.Configuration.Activity_LeadEventsProcess<TEntity> where TEntity : Activity_SSP_Terrasoft
	{
