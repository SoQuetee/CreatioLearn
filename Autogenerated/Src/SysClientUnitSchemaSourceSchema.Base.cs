namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysClientUnitSchemaSource_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysClientUnitSchemaSource
	{
