namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysOrderDirection_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : SysOrderDirection
	{
