namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ContractState_CoreContractsEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ContractState
	{
