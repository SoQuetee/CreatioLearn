namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysPrcEntityHistory_BaseEventsProcess<TEntity> : Terrasoft.Configuration.SysBaseProcessEntity_BaseEventsProcess<TEntity> where TEntity : SysPrcEntityHistory
	{
