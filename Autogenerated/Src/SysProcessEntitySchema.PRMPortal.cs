namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class SysProcessEntitySchema : Terrasoft.Configuration.SysProcessEntity_Base_TerrasoftSchema
	{
	...
	/// Object in process.
	/// </summary>
	public class SysProcessEntity : Terrasoft.Configuration.SysProcessEntity_Base_Terrasoft
	{
	...
	/// <exclude/>
	public partial class SysProcessEntity_PRMPortalEventsProcess<TEntity> : Terrasoft.Configuration.SysProcessEntity_BaseEventsProcess<TEntity> where TEntity : SysProcessEntity
	{
