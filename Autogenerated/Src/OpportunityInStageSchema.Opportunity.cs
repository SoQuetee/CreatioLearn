namespace Terrasoft.Configuration
{
	...
	public class OpportunityInStage_Opportunity_Terrasoft : Terrasoft.Configuration.BaseEntity
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("OpportunityInStage_Opportunity_TerrasoftDeleted", e);
	...
	/// <exclude/>
	public partial class OpportunityInStage_OpportunityEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : OpportunityInStage_Opportunity_Terrasoft
	{
