namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysModuleActionLczOld_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLczEntity_BaseEventsProcess<TEntity> where TEntity : SysModuleActionLczOld
	{
