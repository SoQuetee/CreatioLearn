namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwOAuthAppUser_OAuth20IntegrationEventsProcess<TEntity> : Terrasoft.Configuration.OAuthTokenStorage_BaseEventsProcess<TEntity> where TEntity : VwOAuthAppUser
	{
