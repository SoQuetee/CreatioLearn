namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class TrackingDomain_EventTrackingEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : TrackingDomain
	{
