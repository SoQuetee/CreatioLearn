namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ChangeLogEntity_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : ChangeLogEntity
	{
