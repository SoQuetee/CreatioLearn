namespace Terrasoft.Configuration
{
	...
	public class BulkEmailResponseSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new BulkEmailResponse_BulkEmailEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class BulkEmailResponse_BulkEmailEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : BulkEmailResponse
	{
	...
	public partial class BulkEmailResponse_BulkEmailEventsProcess<TEntity>
	{
