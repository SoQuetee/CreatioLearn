namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CampaignInFolder_CampaignsEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : CampaignInFolder
	{
