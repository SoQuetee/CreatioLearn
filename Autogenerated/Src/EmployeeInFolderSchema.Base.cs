namespace Terrasoft.Configuration
{
	...
	public class EmployeeInFolderSchema : Terrasoft.Configuration.BaseItemInFolderSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new EmployeeInFolder_BaseEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class EmployeeInFolder_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : EmployeeInFolder
	{
	...
	public partial class EmployeeInFolder_BaseEventsProcess<TEntity>
	{
