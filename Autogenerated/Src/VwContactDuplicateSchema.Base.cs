namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwContactDuplicate_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : VwContactDuplicate
	{
