namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class WebServiceV2Folder_ServiceDesignerEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : WebServiceV2Folder
	{
