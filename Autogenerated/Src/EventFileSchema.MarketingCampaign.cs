namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class EventFile_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.File_PRMPortalEventsProcess<TEntity> where TEntity : EventFile
	{
