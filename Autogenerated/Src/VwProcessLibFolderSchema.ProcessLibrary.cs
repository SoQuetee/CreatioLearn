namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwProcessLibFolder_ProcessLibraryEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : VwProcessLibFolder
	{
