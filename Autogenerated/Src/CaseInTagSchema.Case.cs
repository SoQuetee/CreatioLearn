namespace Terrasoft.Configuration
{
	...
	public class CaseInTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new CaseInTag_CaseEventsProcess(userConnection);
		}
	...
	public class CaseInTag : Terrasoft.Configuration.BaseEntityInTag
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new CaseInTag_CaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: CaseInTag_CaseEventsProcess

	/// <exclude/>
	public partial class CaseInTag_CaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : CaseInTag
	{

		public CaseInTag_CaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "CaseInTag_CaseEventsProcess";
	...
	/// <exclude/>
	public class CaseInTag_CaseEventsProcess : CaseInTag_CaseEventsProcess<CaseInTag>
	{
	...
	public partial class CaseInTag_CaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class CaseInTagEventsProcess : CaseInTag_CaseEventsProcess
	{
