namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class OmniChatInTag_OmnichannelMessagingEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : OmniChatInTag
	{
