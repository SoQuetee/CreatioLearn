namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class TouchQueue_TouchPointsEventsProcess<TEntity> : Terrasoft.Configuration.BaseTaskQueue_TasksQueueEventsProcess<TEntity> where TEntity : TouchQueue
	{
