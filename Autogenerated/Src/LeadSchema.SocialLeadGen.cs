namespace Terrasoft.Configuration
{
	...
	#region Class: Lead_SocialLeadGen_TerrasoftSchema

	/// <exclude/>
	public class Lead_SocialLeadGen_TerrasoftSchema : Terrasoft.Configuration.Lead_PRMPortal_TerrasoftSchema
	{

		#region Constructors: Public

		public Lead_SocialLeadGen_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public Lead_SocialLeadGen_TerrasoftSchema(Lead_SocialLeadGen_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public Lead_SocialLeadGen_TerrasoftSchema(Lead_SocialLeadGen_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "Lead_SocialLeadGen_Terrasoft";
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new Lead_SocialLeadGen_Terrasoft(userConnection) {Schema = this};
		}
		...
		public override object Clone() {
			return new Lead_SocialLeadGen_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new Lead_SocialLeadGen_TerrasoftSchema(this, true);
		}
	...
	#region Class: Lead_SocialLeadGen_Terrasoft

	/// <summary>
	/// Lead.
	/// </summary>
	public class Lead_SocialLeadGen_Terrasoft : Terrasoft.Configuration.Lead_PRMPortal_Terrasoft
	{

		#region Constructors: Public

		public Lead_SocialLeadGen_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "Lead_SocialLeadGen_Terrasoft";
		}

		public Lead_SocialLeadGen_Terrasoft(Lead_SocialLeadGen_Terrasoft source)
			: base(source) {
		}
		...
		public override object Clone() {
			return new Lead_SocialLeadGen_Terrasoft(this);
		}
	...
	/// <exclude/>
	public partial class Lead_SocialLeadGenEventsProcess<TEntity> : Terrasoft.Configuration.Lead_PRMPortalEventsProcess<TEntity> where TEntity : Lead_SocialLeadGen_Terrasoft
	{
	...
	/// <exclude/>
	public class Lead_SocialLeadGenEventsProcess : Lead_SocialLeadGenEventsProcess<Lead_SocialLeadGen_Terrasoft>
	{
