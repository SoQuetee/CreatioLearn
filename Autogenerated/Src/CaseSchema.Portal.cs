namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Case_Portal_TerrasoftSchema : Terrasoft.Configuration.Case_CMDB_TerrasoftSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new Case_PortalEventsProcess(userConnection);
		}
	...
	/// Case.
	/// </summary>
	public class Case_Portal_Terrasoft : Terrasoft.Configuration.Case_CMDB_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Case_Portal_TerrasoftDeleted", e);
			Saved += (s, e) => ThrowEvent("Case_Portal_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("Case_Portal_TerrasoftSaving", e);
			SaveError += (s, e) => ThrowEvent("Case_Portal_TerrasoftSaveError", e);
	...
	/// <exclude/>
	public partial class Case_PortalEventsProcess<TEntity> : Terrasoft.Configuration.Case_CMDBEventsProcess<TEntity> where TEntity : Case_Portal_Terrasoft
	{
