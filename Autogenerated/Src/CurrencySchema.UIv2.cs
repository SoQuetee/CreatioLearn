namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class Currency_UIv2EventsProcess<TEntity> : Terrasoft.Configuration.Currency_BaseEventsProcess<TEntity> where TEntity : Currency_UIv2_Terrasoft
	{
