namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class OpportunityFileSchema : Terrasoft.Configuration.OpportunityFile_Opportunity_TerrasoftSchema
	{
	...
	/// </summary>
	public class OpportunityFile : Terrasoft.Configuration.OpportunityFile_Opportunity_Terrasoft
	{
	...
	/// <exclude/>
	public partial class OpportunityFile_PRMPortalEventsProcess<TEntity> : Terrasoft.Configuration.OpportunityFile_OpportunityEventsProcess<TEntity> where TEntity : OpportunityFile
	{
