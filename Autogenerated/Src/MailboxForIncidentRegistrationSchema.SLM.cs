namespace Terrasoft.Configuration
{
	...
	public class MailboxForIncidentRegistrationSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new MailboxForIncidentRegistration_SLMEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class MailboxForIncidentRegistration_SLMEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : MailboxForIncidentRegistration
	{
	...
	public partial class MailboxForIncidentRegistration_SLMEventsProcess<TEntity>
	{
