namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class FolderFavorite_NUIEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : FolderFavorite
	{
