namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Invoice_PRMPortal_TerrasoftSchema : Terrasoft.Configuration.Invoice_Passport_TerrasoftSchema
	{
	...
	/// Invoice.
	/// </summary>
	public class Invoice_PRMPortal_Terrasoft : Terrasoft.Configuration.Invoice_Passport_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			...
			Inserted += (s, e) => ThrowEvent("Invoice_PRMPortal_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("Invoice_PRMPortal_TerrasoftInserting", e);
	...
	/// <exclude/>
	public partial class Invoice_PRMPortalEventsProcess<TEntity> : Terrasoft.Configuration.Invoice_PassportEventsProcess<TEntity> where TEntity : Invoice_PRMPortal_Terrasoft
	{
