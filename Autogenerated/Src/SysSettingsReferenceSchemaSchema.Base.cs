namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysSettingsReferenceSchema_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysSettingsReferenceSchema
	{
