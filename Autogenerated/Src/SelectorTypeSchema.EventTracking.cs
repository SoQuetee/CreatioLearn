namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SelectorType_EventTrackingEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : SelectorType
	{
