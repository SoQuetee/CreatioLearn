namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysEntitySchemaParentAsscType_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : SysEntitySchemaParentAsscType
	{
