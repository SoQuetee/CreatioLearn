namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class InvoiceInFolder_InvoiceEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : InvoiceInFolder
	{
