namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class MultiDeleteDenyReason_NUIEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : MultiDeleteDenyReason
	{
