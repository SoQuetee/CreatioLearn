namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class RemindingSource_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : RemindingSource
	{
