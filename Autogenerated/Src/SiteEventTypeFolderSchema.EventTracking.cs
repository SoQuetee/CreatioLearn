namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SiteEventTypeFolder_EventTrackingEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : SiteEventTypeFolder
	{
