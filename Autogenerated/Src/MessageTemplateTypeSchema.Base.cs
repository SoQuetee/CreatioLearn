namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class MessageTemplateType_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : MessageTemplateType
	{
