namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class OpportunityCloseReason_OpportunityEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : OpportunityCloseReason
	{
