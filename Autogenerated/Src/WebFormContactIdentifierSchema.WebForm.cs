namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class WebFormContactIdentifier_WebFormEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : WebFormContactIdentifier
	{
