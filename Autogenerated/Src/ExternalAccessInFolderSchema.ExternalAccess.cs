namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ExternalAccessInFolder_ExternalAccessEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : ExternalAccessInFolder
	{
