namespace Terrasoft.Configuration
{
	...
	public class KnowledgeBaseTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new KnowledgeBaseType_BaseEventsProcess(userConnection);
		}
	...
	public class KnowledgeBaseType : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new KnowledgeBaseType_BaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: KnowledgeBaseType_BaseEventsProcess

	/// <exclude/>
	public partial class KnowledgeBaseType_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : KnowledgeBaseType
	{

		public KnowledgeBaseType_BaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "KnowledgeBaseType_BaseEventsProcess";
	...
	/// <exclude/>
	public class KnowledgeBaseType_BaseEventsProcess : KnowledgeBaseType_BaseEventsProcess<KnowledgeBaseType>
	{
	...
	public partial class KnowledgeBaseType_BaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class KnowledgeBaseTypeEventsProcess : KnowledgeBaseType_BaseEventsProcess
	{
