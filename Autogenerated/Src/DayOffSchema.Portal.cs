namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class DayOffSchema : Terrasoft.Configuration.DayOff_Calendar_TerrasoftSchema
	{
	...
	/// Days off.
	/// </summary>
	public class DayOff : Terrasoft.Configuration.DayOff_Calendar_Terrasoft
	{
	...
	/// <exclude/>
	public partial class DayOff_PortalEventsProcess<TEntity> : Terrasoft.Configuration.DayOff_CalendarEventsProcess<TEntity> where TEntity : DayOff
	{
