namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysDateTimeFormat_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : SysDateTimeFormat
	{
