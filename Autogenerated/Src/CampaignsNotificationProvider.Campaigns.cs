namespace Terrasoft.Configuration
{
	...
	#region Class: CampaignsNotificationProvider

	/// <summary>
	/// Campaign notification provider.
	/// </summary>
	public class CampaignsNotificationProvider : BaseNotificationProvider, INotificationProvider
	{
		#region Fields: Private

		private const string GROUP_NAME = "Notification";
		private const string NAME = "Campaigns";

		#endregion

		#region Constructors: Public

		public CampaignsNotificationProvider(UserConnection userConnection)
			: base(userConnection) {
		}

		public CampaignsNotificationProvider(Dictionary<string, object> parameters)
			: base(parameters) {
		}
		...
		protected override void AddColumns(Select select) {
			select
				...
				.Column("Campaign", "Id").As("CampaignId")
				.Column("Campaign", "Name").As("Title")
		...
		protected override void JoinTables(Select select) {
			select
				...
				.InnerJoin("Campaign").On("Reminding", "SubjectId").IsEqual("Campaign", "Id")
		...
		protected override INotificationInfo GetRecordNotificationInfo(
			...
			return new NotificationInfo() {
				...
				ImageId = imageId,
				EntityId = new Guid(dictionaryColumnValues["CampaignId"]),
