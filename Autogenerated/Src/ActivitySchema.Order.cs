namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Activity_Order_TerrasoftSchema : Terrasoft.Configuration.Activity_Invoice_TerrasoftSchema
	{
	...
	/// Activity.
	/// </summary>
	public class Activity_Order_Terrasoft : Terrasoft.Configuration.Activity_Invoice_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Activity_Order_TerrasoftDeleted", e);
	...
	/// <exclude/>
	public partial class Activity_OrderEventsProcess<TEntity> : Terrasoft.Configuration.Activity_InvoiceEventsProcess<TEntity> where TEntity : Activity_Order_Terrasoft
	{
