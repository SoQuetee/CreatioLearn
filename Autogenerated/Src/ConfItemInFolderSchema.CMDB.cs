namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ConfItemInFolder_CMDBEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : ConfItemInFolder
	{
