namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ReferrerName_TouchPointsEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ReferrerName
	{
