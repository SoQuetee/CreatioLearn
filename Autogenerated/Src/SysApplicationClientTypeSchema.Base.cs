namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysApplicationClientType_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : SysApplicationClientType
	{
