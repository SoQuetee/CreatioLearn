namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class MeetingServiceLink_IntegrationV2EventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : MeetingServiceLink
	{
