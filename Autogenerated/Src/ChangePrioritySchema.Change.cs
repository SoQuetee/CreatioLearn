namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ChangePriority_ChangeEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ChangePriority
	{
