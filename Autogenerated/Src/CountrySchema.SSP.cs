namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class CountrySchema : Terrasoft.Configuration.Country_Base_TerrasoftSchema
	{
	...
	/// Country.
	/// </summary>
	public class Country : Terrasoft.Configuration.Country_Base_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Country_SSPEventsProcess<TEntity> : Terrasoft.Configuration.Country_BaseEventsProcess<TEntity> where TEntity : Country
	{
