namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class KnowledgeBase_SspKnowledgeBase_TerrasoftSchema : Terrasoft.Configuration.KnowledgeBase_Base_TerrasoftSchema
	{
	...
	/// </summary>
	public class KnowledgeBase_SspKnowledgeBase_Terrasoft : Terrasoft.Configuration.KnowledgeBase_Base_Terrasoft
	{
	...
	/// <exclude/>
	public partial class KnowledgeBase_SspKnowledgeBaseEventsProcess<TEntity> : Terrasoft.Configuration.KnowledgeBase_BaseEventsProcess<TEntity> where TEntity : KnowledgeBase_SspKnowledgeBase_Terrasoft
	{
