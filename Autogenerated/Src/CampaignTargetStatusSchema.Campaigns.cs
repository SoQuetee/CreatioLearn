namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CampaignTargetStatus_CampaignsEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : CampaignTargetStatus
	{
