namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ProductInTag_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : ProductInTag
	{
