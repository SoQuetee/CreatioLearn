namespace Terrasoft.Configuration
{
	...
	public class ContactDuplicateSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new ContactDuplicate_BaseEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class ContactDuplicate_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : ContactDuplicate
	{
	...
	public partial class ContactDuplicate_BaseEventsProcess<TEntity>
	{
