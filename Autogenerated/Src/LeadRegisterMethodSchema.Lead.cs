namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class LeadRegisterMethod_LeadEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : LeadRegisterMethod
	{
