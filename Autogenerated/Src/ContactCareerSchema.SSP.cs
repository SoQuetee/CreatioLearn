namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ContactCareer_SSPEventsProcess<TEntity> : Terrasoft.Configuration.ContactCareer_BaseEventsProcess<TEntity> where TEntity : ContactCareer
	{
