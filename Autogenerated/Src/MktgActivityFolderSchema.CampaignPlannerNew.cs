namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class MktgActivityFolder_CampaignPlannerNewEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : MktgActivityFolder
	{
