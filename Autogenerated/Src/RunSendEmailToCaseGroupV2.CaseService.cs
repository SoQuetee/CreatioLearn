namespace Terrasoft.Core.Process
{
	...
	/// <exclude/>
	public class RunSendEmailToCaseGroupV2Schema : Terrasoft.Core.Process.ProcessSchema
	{
	...
	/// <exclude/>
	public class RunSendEmailToCaseGroupV2 : Terrasoft.Core.Process.Process
	{
