namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class DependencyType_ServiceModelEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : DependencyType
	{
