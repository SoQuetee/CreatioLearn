namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysEntityPrcStartEvent_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysEntityPrcStartEvent
	{
