namespace Terrasoft.Configuration
{
	...
	public class SysModuleReportTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new SysModuleReportType_BaseEventsProcess(userConnection);
		}
	...
	public class SysModuleReportType : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new SysModuleReportType_BaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: SysModuleReportType_BaseEventsProcess

	/// <exclude/>
	public partial class SysModuleReportType_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : SysModuleReportType
	{

		public SysModuleReportType_BaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "SysModuleReportType_BaseEventsProcess";
	...
	/// <exclude/>
	public class SysModuleReportType_BaseEventsProcess : SysModuleReportType_BaseEventsProcess<SysModuleReportType>
	{
	...
	public partial class SysModuleReportType_BaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class SysModuleReportTypeEventsProcess : SysModuleReportType_BaseEventsProcess
	{
