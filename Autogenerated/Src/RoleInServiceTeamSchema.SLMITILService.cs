namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class RoleInServiceTeam_SLMITILServiceEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : RoleInServiceTeam
	{
