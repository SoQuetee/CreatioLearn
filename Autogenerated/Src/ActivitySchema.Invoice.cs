namespace Terrasoft.Configuration
{
	...
	public class Activity_Invoice_Terrasoft : Terrasoft.Configuration.Activity_Portal_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Activity_Invoice_TerrasoftDeleted", e);
	...
	/// <exclude/>
	public partial class Activity_InvoiceEventsProcess<TEntity> : Terrasoft.Configuration.Activity_PortalEventsProcess<TEntity> where TEntity : Activity_Invoice_Terrasoft
	{
