namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Order_PRMOrder_TerrasoftSchema : Terrasoft.Configuration.Order_Passport_TerrasoftSchema
	{
	...
	/// Order.
	/// </summary>
	public class Order_PRMOrder_Terrasoft : Terrasoft.Configuration.Order_Passport_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Order_PRMOrderEventsProcess<TEntity> : Terrasoft.Configuration.Order_PassportEventsProcess<TEntity> where TEntity : Order_PRMOrder_Terrasoft
	{
