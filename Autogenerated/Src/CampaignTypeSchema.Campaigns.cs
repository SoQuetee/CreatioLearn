namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CampaignType_CampaignsEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : CampaignType
	{
