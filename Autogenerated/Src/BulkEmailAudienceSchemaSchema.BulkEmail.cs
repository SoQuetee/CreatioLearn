namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BulkEmailAudienceSchema_BulkEmailEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : BulkEmailAudienceSchema
	{
