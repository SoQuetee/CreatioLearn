namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class EmailDeliverySchedule_BulkEmailEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : EmailDeliverySchedule
	{
