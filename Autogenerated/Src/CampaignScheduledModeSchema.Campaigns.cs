namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CampaignScheduledMode_CampaignsEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : CampaignScheduledMode
	{
