namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class LeadGenNetworkType_SocialLeadGenEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : LeadGenNetworkType
	{
