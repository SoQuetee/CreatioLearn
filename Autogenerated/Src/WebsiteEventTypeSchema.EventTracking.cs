namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class WebsiteEventType_EventTrackingEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : WebsiteEventType
	{
