namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class EventInFolder_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : EventInFolder
	{
