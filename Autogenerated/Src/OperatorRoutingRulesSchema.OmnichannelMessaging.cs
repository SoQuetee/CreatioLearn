namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class OperatorRoutingRules_OmnichannelMessagingEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : OperatorRoutingRules
	{
