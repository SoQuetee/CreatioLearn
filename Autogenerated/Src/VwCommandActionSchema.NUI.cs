namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwCommandAction_NUIEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : VwCommandAction
	{
