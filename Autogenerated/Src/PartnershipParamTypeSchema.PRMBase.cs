namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class PartnershipParamType_PRMBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : PartnershipParamType
	{
