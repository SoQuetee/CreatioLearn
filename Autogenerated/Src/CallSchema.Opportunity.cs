namespace Terrasoft.Configuration
{
	...
	public class Call_Opportunity_Terrasoft : Terrasoft.Configuration.Call_CaseService_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Call_Opportunity_TerrasoftDeleted", e);
	...
	/// <exclude/>
	public partial class Call_OpportunityEventsProcess<TEntity> : Terrasoft.Configuration.Call_CaseServiceEventsProcess<TEntity> where TEntity : Call_Opportunity_Terrasoft
	{
