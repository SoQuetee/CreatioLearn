namespace Terrasoft.Configuration
{
	...
	public class VwGroupSysAdminUnit : Terrasoft.Configuration.SysAdminUnit
	{
		...
		protected override void InitializeThrowEvents() {
			Inserted += (s, e) => ThrowEvent("VwGroupSysAdminUnitInserted", e);
			Saving += (s, e) => ThrowEvent("VwGroupSysAdminUnitSaving", e);
			Updated += (s, e) => ThrowEvent("VwGroupSysAdminUnitUpdated", e);
	...
	/// <exclude/>
	public partial class VwGroupSysAdminUnit_CaseEventsProcess<TEntity> : Terrasoft.Configuration.SysAdminUnit_SSPEventsProcess<TEntity> where TEntity : VwGroupSysAdminUnit
	{
