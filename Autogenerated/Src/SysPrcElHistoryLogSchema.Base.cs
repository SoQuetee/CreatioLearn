namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysPrcElHistoryLog_BaseEventsProcess<TEntity> : Terrasoft.Configuration.SysBasePrcElLog_BaseEventsProcess<TEntity> where TEntity : SysPrcElHistoryLog
	{
