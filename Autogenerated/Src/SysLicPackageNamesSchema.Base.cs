namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysLicPackageNames_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysLicPackageNames
	{
