namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CampaignFirePeriod_CampaignDesignerEventsProcess<TEntity> : Terrasoft.Configuration.BaseValueLookup_BaseEventsProcess<TEntity> where TEntity : CampaignFirePeriod
	{
