namespace Terrasoft.Configuration
{
	...
	public class SocialChannelPublisherSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new SocialChannelPublisher_ESNEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class SocialChannelPublisher_ESNEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SocialChannelPublisher
	{
	...
	public partial class SocialChannelPublisher_ESNEventsProcess<TEntity>
	{
