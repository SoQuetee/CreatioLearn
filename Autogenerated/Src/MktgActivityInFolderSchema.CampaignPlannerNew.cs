namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class MktgActivityInFolder_CampaignPlannerNewEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : MktgActivityInFolder
	{
