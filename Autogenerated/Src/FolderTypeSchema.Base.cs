namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class FolderType_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeImageLookup_BaseEventsProcess<TEntity> where TEntity : FolderType
	{
