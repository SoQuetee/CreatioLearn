namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class EduActivityStatus_PRMBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : EduActivityStatus
	{
