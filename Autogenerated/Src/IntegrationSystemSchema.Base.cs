namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class IntegrationSystem_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : IntegrationSystem
	{
