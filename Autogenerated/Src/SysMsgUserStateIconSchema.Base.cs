namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysMsgUserStateIcon_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseImageLookup_BaseEventsProcess<TEntity> where TEntity : SysMsgUserStateIcon
	{
