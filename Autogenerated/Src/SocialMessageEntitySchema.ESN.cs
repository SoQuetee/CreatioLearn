namespace Terrasoft.Configuration
{
	...
	public class SocialMessageEntitySchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new SocialMessageEntity_ESNEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class SocialMessageEntity_ESNEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SocialMessageEntity
	{
	...
	public partial class SocialMessageEntity_ESNEventsProcess<TEntity>
	{
