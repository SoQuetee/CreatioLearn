namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysModuleEditLczOld_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLczEntity_BaseEventsProcess<TEntity> where TEntity : SysModuleEditLczOld
	{
