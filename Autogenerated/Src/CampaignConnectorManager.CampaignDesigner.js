define("CampaignConnectorManager", [], function() {
	...
	Ext.define("Terrasoft.CampaignConnectorManager", {
		...
		initMappingCollection: function() {
			...
			collection.add("CampaignAddToEventSchema", "Terrasoft.ProcessEventConditionalTransitionSchema");
			collection.add("CampaignStartEventSchema", "Terrasoft.ProcessEventConditionalTransitionSchema");
