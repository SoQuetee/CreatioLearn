namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ProductType_ProductCatalogueEventsProcess<TEntity> : Terrasoft.Configuration.ProductType_ProductBaseEventsProcess<TEntity> where TEntity : ProductType
	{
