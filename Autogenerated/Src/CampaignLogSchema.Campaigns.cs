namespace Terrasoft.Configuration
{
	...
	public class CampaignLogSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new CampaignLog_CampaignsEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class CampaignLog_CampaignsEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : CampaignLog
	{
	...
	public partial class CampaignLog_CampaignsEventsProcess<TEntity>
	{
