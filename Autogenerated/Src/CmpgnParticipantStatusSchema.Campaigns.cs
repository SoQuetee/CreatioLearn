namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CmpgnParticipantStatus_CampaignsEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : CmpgnParticipantStatus
	{
