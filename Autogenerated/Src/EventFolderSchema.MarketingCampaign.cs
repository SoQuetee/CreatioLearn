namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class EventFolder_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : EventFolder
	{
