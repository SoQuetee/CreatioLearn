namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CashflowCategory_ProjectEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : CashflowCategory
	{
