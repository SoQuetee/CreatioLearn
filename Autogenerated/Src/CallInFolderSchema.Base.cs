namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CallInFolder_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : CallInFolder
	{
