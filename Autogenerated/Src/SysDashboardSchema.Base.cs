namespace Terrasoft.Configuration
{
	...
	public class SysDashboard_Base_Terrasoft : Terrasoft.Configuration.BaseEntity
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("SysDashboard_Base_TerrasoftDeleted", e);
	...
	/// <exclude/>
	public partial class SysDashboard_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysDashboard_Base_Terrasoft
	{
