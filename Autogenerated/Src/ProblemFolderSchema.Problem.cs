namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ProblemFolder_ProblemEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : ProblemFolder
	{
