namespace Terrasoft.Configuration
{
	...
	public class SysMsgUserStateInLibSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new SysMsgUserStateInLib_BaseEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class SysMsgUserStateInLib_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysMsgUserStateInLib
	{
	...
	public partial class SysMsgUserStateInLib_BaseEventsProcess<TEntity>
	{
