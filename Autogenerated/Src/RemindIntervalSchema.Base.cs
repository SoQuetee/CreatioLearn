namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class RemindInterval_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseValueLookup_BaseEventsProcess<TEntity> where TEntity : RemindInterval
	{
