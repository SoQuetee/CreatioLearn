namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class DistributionTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
	...
	/// Bulk email type.
	/// </summary>
	public class DistributionType : Terrasoft.Configuration.BaseLookup
	{
	...
	/// <exclude/>
	public partial class DistributionType_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : DistributionType
	{
