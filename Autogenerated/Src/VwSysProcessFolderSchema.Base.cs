namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwSysProcessFolder_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : VwSysProcessFolder
	{
