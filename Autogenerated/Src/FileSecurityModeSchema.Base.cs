namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class FileSecurityMode_BaseEventsProcess<TEntity> : Terrasoft.Configuration.Lookup_BaseEventsProcess<TEntity> where TEntity : FileSecurityMode
	{
