namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CompetenceLevel_PRMBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : CompetenceLevel
	{
