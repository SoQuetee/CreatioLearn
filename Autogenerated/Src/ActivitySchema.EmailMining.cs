namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Activity_EmailMining_TerrasoftSchema : Terrasoft.Configuration.Activity_OmnichannelMessaging_TerrasoftSchema
	{
	...
	/// Activity.
	/// </summary>
	public class Activity_EmailMining_Terrasoft : Terrasoft.Configuration.Activity_OmnichannelMessaging_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Activity_EmailMining_TerrasoftDeleted", e);
	...
	/// <exclude/>
	public partial class Activity_EmailMiningEventsProcess<TEntity> : Terrasoft.Configuration.Activity_OmnichannelMessagingEventsProcess<TEntity> where TEntity : Activity_EmailMining_Terrasoft
	{
