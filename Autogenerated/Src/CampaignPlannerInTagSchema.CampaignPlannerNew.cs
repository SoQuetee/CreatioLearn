namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CampaignPlannerInTag_CampaignPlannerNewEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : CampaignPlannerInTag
	{
