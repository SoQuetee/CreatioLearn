namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysProcessLogFolder_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : SysProcessLogFolder
	{
