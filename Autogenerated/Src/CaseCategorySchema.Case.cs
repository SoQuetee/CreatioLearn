namespace Terrasoft.Configuration
{
	...
	public class CaseCategorySchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new CaseCategory_CaseEventsProcess(userConnection);
		}
	...
	public class CaseCategory : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new CaseCategory_CaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: CaseCategory_CaseEventsProcess

	/// <exclude/>
	public partial class CaseCategory_CaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : CaseCategory
	{

		public CaseCategory_CaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "CaseCategory_CaseEventsProcess";
	...
	/// <exclude/>
	public class CaseCategory_CaseEventsProcess : CaseCategory_CaseEventsProcess<CaseCategory>
	{
	...
	public partial class CaseCategory_CaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class CaseCategoryEventsProcess : CaseCategory_CaseEventsProcess
	{
