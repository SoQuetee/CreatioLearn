namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class HeaderProperty_JunkFilterEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : HeaderProperty
	{
