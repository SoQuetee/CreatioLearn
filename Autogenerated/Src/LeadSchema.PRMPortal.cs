namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Lead_PRMPortal_TerrasoftSchema : Terrasoft.Configuration.Lead_OrderLead_TerrasoftSchema
	{
	...
	/// Lead.
	/// </summary>
	public class Lead_PRMPortal_Terrasoft : Terrasoft.Configuration.Lead_OrderLead_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Lead_PRMPortalEventsProcess<TEntity> : Terrasoft.Configuration.Lead_OrderLeadEventsProcess<TEntity> where TEntity : Lead_PRMPortal_Terrasoft
	{
