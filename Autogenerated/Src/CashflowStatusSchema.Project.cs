namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CashflowStatus_ProjectEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : CashflowStatus
	{
