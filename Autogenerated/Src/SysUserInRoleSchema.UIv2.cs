namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysUserInRole_UIv2EventsProcess<TEntity> : Terrasoft.Configuration.SysUserInRole_BaseEventsProcess<TEntity> where TEntity : SysUserInRole
	{
