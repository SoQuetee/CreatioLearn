namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysModuleEdit_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysModuleEdit
	{
