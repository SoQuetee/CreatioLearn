namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class PortalMessageType_PortalMessageEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : PortalMessageType
	{
