namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SamlResponse_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SamlResponse
	{
