namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysAdminUnitFolder_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : SysAdminUnitFolder
	{
