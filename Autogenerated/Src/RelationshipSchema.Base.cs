namespace Terrasoft.Configuration
{
	...
	public class RelationshipSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new Relationship_BaseEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class Relationship_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : Relationship
	{
