namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class SocialMentionSchema : Terrasoft.Configuration.SocialMention_ESN_TerrasoftSchema
	{
	...
	/// User mention.
	/// </summary>
	public class SocialMention : Terrasoft.Configuration.SocialMention_ESN_Terrasoft
	{
	...
	/// <exclude/>
	public partial class SocialMention_SSPEventsProcess<TEntity> : Terrasoft.Configuration.SocialMention_ESNEventsProcess<TEntity> where TEntity : SocialMention
	{
