namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BulkEmailSplitFile_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.File_PRMPortalEventsProcess<TEntity> where TEntity : BulkEmailSplitFile
	{
