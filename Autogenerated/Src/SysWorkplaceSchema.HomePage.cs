namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class SysWorkplaceSchema : Terrasoft.Configuration.SysWorkplace_NUI_TerrasoftSchema
	{
	...
	/// User's workplace.
	/// </summary>
	public class SysWorkplace : Terrasoft.Configuration.SysWorkplace_NUI_Terrasoft
	{
	...
	/// <exclude/>
	public partial class SysWorkplace_HomePageEventsProcess<TEntity> : Terrasoft.Configuration.SysWorkplace_NUIEventsProcess<TEntity> where TEntity : SysWorkplace
	{
