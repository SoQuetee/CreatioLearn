namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysPackageDataLcz_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysPackageDataLcz
	{
