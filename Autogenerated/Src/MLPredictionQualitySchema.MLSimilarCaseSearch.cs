namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class MLPredictionQuality_MLSimilarCaseSearchEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : MLPredictionQuality
	{
