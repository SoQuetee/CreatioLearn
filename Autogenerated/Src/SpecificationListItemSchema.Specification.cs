namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SpecificationListItem_SpecificationEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SpecificationListItem
	{
