namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class RecommendProductStatus_RecommendedProductEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : RecommendProductStatus
	{
