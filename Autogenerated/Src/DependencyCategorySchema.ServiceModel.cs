namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class DependencyCategory_ServiceModelEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : DependencyCategory
	{
