namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysRegistrationData_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysRegistrationData
	{
