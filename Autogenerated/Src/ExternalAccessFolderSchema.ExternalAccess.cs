namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ExternalAccessFolder_ExternalAccessEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : ExternalAccessFolder
	{
