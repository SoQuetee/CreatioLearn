namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class FinishedSyncSession_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : FinishedSyncSession
	{
