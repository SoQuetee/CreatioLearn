namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class AccountAnnualRevenue_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : AccountAnnualRevenue
	{
