namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class MailSyncPeriod_ExchangeEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : MailSyncPeriod
	{
