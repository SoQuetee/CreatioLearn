namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class Contract_CoreContractsEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : Contract_CoreContracts_Terrasoft
	{
