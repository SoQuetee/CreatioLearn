namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class LeadGenCampaigns_SocialLeadGenEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : LeadGenCampaigns
	{
