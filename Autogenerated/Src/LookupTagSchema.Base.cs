namespace Terrasoft.Configuration
{
	...
	public class LookupTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new LookupTag_BaseEventsProcess(userConnection);
		}
	...
	public class LookupTag : Terrasoft.Configuration.BaseTag
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new LookupTag_BaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: LookupTag_BaseEventsProcess

	/// <exclude/>
	public partial class LookupTag_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : LookupTag
	{

		public LookupTag_BaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "LookupTag_BaseEventsProcess";
	...
	/// <exclude/>
	public class LookupTag_BaseEventsProcess : LookupTag_BaseEventsProcess<LookupTag>
	{
	...
	public partial class LookupTag_BaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class LookupTagEventsProcess : LookupTag_BaseEventsProcess
	{
