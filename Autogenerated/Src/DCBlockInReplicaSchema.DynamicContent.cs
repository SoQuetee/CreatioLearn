namespace Terrasoft.Configuration
{
	...
	public class DCBlockInReplicaSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new DCBlockInReplica_DynamicContentEventsProcess(userConnection);
		}
	...
	/// <exclude/>
	public partial class DCBlockInReplica_DynamicContentEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : DCBlockInReplica
	{
	...
	public partial class DCBlockInReplica_DynamicContentEventsProcess<TEntity>
	{
