namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BaseValueLookup_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : BaseValueLookup
	{
