namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class OAuth20AppInTag_OAuth20IntegrationEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : OAuth20AppInTag
	{
