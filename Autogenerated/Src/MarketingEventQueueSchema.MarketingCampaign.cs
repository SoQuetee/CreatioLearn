namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class MarketingEventQueue_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseTaskQueue_TasksQueueEventsProcess<TEntity> where TEntity : MarketingEventQueue
	{
