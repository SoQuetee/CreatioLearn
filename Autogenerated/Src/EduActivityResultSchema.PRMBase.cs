namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class EduActivityResult_PRMBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : EduActivityResult
	{
