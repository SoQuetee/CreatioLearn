namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class StatusOfActivity_PRMBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : StatusOfActivity
	{
