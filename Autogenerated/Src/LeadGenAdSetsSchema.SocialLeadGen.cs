namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class LeadGenAdSets_SocialLeadGenEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : LeadGenAdSets
	{
