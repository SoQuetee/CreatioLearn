namespace Terrasoft.Configuration
{
	...
	public class BrandSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new Brand_BaseEventsProcess(userConnection);
		}
	...
	public class Brand : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new Brand_BaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: Brand_BaseEventsProcess

	/// <exclude/>
	public partial class Brand_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : Brand
	{

		public Brand_BaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "Brand_BaseEventsProcess";
	...
	/// <exclude/>
	public class Brand_BaseEventsProcess : Brand_BaseEventsProcess<Brand>
	{
	...
	public partial class Brand_BaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class BrandEventsProcess : Brand_BaseEventsProcess
	{
