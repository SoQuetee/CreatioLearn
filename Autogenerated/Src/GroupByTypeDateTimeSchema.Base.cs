namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class GroupByTypeDateTime_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : GroupByTypeDateTime
	{
