namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class DuplicatesHistory_DeduplicationEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : DuplicatesHistory
	{
