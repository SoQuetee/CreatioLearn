namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ReleaseStatus_ReleaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ReleaseStatus
	{
