namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class VwSystemUsersSchema : Terrasoft.Configuration.VwSystemUsers_Base_TerrasoftSchema
	{
	...
	/// System users (view).
	/// </summary>
	public class VwSystemUsers : Terrasoft.Configuration.VwSystemUsers_Base_Terrasoft
	{
	...
	/// <exclude/>
	public partial class VwSystemUsers_PRMOrderEventsProcess<TEntity> : Terrasoft.Configuration.VwSystemUsers_BaseEventsProcess<TEntity> where TEntity : VwSystemUsers
	{
