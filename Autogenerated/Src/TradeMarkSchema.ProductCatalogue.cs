namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class TradeMark_ProductCatalogueEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : TradeMark
	{
