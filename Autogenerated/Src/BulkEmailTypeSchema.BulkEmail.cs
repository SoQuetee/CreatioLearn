namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BulkEmailType_BulkEmailEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : BulkEmailType
	{
