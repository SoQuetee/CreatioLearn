namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class Activity_ProjectEventsProcess<TEntity> : Terrasoft.Configuration.Activity_OrderEventsProcess<TEntity> where TEntity : Activity_Project_Terrasoft
	{
