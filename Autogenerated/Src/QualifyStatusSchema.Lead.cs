namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class QualifyStatus_LeadEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : QualifyStatus_Lead_Terrasoft
	{
