namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class DocumentState_DocumentEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : DocumentState
	{
