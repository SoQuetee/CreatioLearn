namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class MandrillWebhook_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : MandrillWebhook
	{
