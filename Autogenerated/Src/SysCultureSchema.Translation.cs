namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysCulture_TranslationEventsProcess<TEntity> : Terrasoft.Configuration.SysCulture_BaseEventsProcess<TEntity> where TEntity : SysCulture
	{
