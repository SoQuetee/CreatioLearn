namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class OperatorState_OmnichannelMessagingEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : OperatorState
	{
