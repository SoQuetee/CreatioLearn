namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class JobChangeReason_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : JobChangeReason
	{
