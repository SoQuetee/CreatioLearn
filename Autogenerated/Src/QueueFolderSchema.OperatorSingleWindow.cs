namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class QueueFolder_OperatorSingleWindowEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : QueueFolder
	{
