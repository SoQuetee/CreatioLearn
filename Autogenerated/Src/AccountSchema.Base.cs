namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class Account_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : Account_Base_Terrasoft
	{
