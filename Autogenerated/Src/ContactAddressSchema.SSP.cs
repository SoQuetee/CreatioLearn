namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class ContactAddressSchema : Terrasoft.Configuration.ContactAddress_Base_TerrasoftSchema
	{
	...
	/// Contact address.
	/// </summary>
	public class ContactAddress : Terrasoft.Configuration.ContactAddress_Base_Terrasoft
	{
	...
	/// <exclude/>
	public partial class ContactAddress_SSPEventsProcess<TEntity> : Terrasoft.Configuration.ContactAddress_BaseEventsProcess<TEntity> where TEntity : ContactAddress
	{
