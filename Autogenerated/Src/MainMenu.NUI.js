define("MainMenu", ["ext-base", "terrasoft", "sandbox", "MainMenuResources", "SysModule", "SysModuleFolder",
	"LocalizationUtilities", "ModuleUtils", "MaskHelper", "ServiceHelper",
	...
	function(Ext, Terrasoft, sandbox, resources, SysModule, SysModuleFolder, LocalizationUtilities, ModuleUtils,
		MaskHelper, ServiceHelper, RightUtilities, PackageHelper, ConfigurationConstants) {
		...
		var initHistoryState = function() {
			...
			var newState = prepareHistoryState(currentState);
		...
		var prepareHistoryState = function(currentState) {
