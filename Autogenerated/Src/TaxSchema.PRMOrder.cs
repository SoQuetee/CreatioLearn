namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class TaxSchema : Terrasoft.Configuration.Tax_Base_TerrasoftSchema
	{
	...
	/// Tax.
	/// </summary>
	public class Tax : Terrasoft.Configuration.Tax_Base_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Tax_PRMOrderEventsProcess<TEntity> : Terrasoft.Configuration.Tax_BaseEventsProcess<TEntity> where TEntity : Tax
	{
