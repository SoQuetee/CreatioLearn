namespace Terrasoft.Configuration
{
	...
	public class ProductUnit_ProductCatalogue_Terrasoft : Terrasoft.Configuration.BaseEntity
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("ProductUnit_ProductCatalogue_TerrasoftDeleted", e);
	...
	/// <exclude/>
	public partial class ProductUnit_ProductCatalogueEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : ProductUnit_ProductCatalogue_Terrasoft
	{
